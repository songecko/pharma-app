<!--Video Intro-->
function educacionFarmaceutico_hipoglos_04()
{
	CleanScreen() ;
	gotoSlide = 'educacionFarmaceutico_hipoglos_04' ;
	...
	*****************************/
	/////////////////////////////////Mexico
	var educacionFarmaceutico_hipoglos_04_mexico =
		//Logo
	...
	/////////////////////////////////Video
	var educacionFarmaceutico_hipoglos_04_brasil =
		//Logo
		"<div class='hipoglos_logoHipoglos' id='hipoglos_logoHipoglos'><img src='img/Hipoglos/img_logoHipoglos_wStroke.png' height='50'></div>"+
		...
		"<div class='videoContainer' id='videoContainer'>"+
			...
			//Video Screen
			"<div class='videoScreen' id='videoScreen'><video controls='controls' autoplay='autoplay' id='vid_educacionFarmaceutico_hipoglos_04' width='1090' height='614'></video></div>"+
	...
	***********************************************/
	...
	switch( languageCountry )
	{
		//México
		case 1:
			document.getElementById("Container").innerHTML = generalElements + educacionFarmaceutico_hipoglos_04_mexico ;
			...
			***********************************************/
			...
			/////////////////////////////////Exit Animation
			function exit_educacionFarmaceutico_hipoglos_04_mex()
			{
				var noDisponible = document.getElementById("noDisponible") ;
				...
				function ChangePage()
				{
					...
					{						
						...
						case 1:
							educacionFarmaceutico_hipoglos_05() ;
						break;
					}
				}
			...
			***********************************************/
			...
			$('#ico_01').click(function() {
				pagChange = -2 ;
				exit_educacionFarmaceutico_hipoglos_04_mex() ;
			});
			...
			$('#worlMap_icon').click(function() {
				pagChange = -1 ;
				//educacionFarmaceutico_hipoglos_04.src = '' ;
				exit_educacionFarmaceutico_hipoglos_04_mex() ;
			}) ;
		...
		//Brasil
		case 5:
			document.getElementById("Container").innerHTML = generalElements + educacionFarmaceutico_hipoglos_04_brasil ;
			...
			***********************************************/
			/////////////////////////////////Main Animation
			var vid_educacionFarmaceutico_hipoglos_04 = document.getElementById("vid_educacionFarmaceutico_hipoglos_04") ;
			...
			function PlayVideo()
			{
				vid_educacionFarmaceutico_hipoglos_04.src = 'video/EducacionFarmaceutico/vid_demoHipoglos.mp4' ;
				vid_educacionFarmaceutico_hipoglos_04.pause() ;
				
				if(vid_educacionFarmaceutico_hipoglos_04.paused)
				{
					vid_educacionFarmaceutico_hipoglos_04.play() ;
				}
			}
			
			/////////////////////////////////Exit Animation
			function exit_educacionFarmaceutico_hipoglos_04()
			{
				var vid_educacionFarmaceutico_hipoglos_04 = document.getElementById("vid_educacionFarmaceutico_hipoglos_04") ;
				vid_educacionFarmaceutico_hipoglos_04.src = '' ;
			...
			***********************************************/
			...
			$('#ico_01').click(function() {
				pagChange = -2 ;
				exit_educacionFarmaceutico_hipoglos_04() ;
			});
