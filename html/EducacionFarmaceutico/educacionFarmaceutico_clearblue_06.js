<!--Video Intro-->
function educacionFarmaceutico_clearblue_06()
{
	CleanScreen() ;
	gotoSlide = 'educacionFarmaceutico_clearblue_06' ;
	...
	*****************************/
	/////////////////////////////////México
	var educacionFarmaceutico_clearblue_06_mexico =
		//Video
			//Container
		"<div class='videoContainer' id='videoContainer'>"+

			//Video Screen
			"<div class='videoScreen' id='videoScreen'><video controls='controls' autoplay='autoplay' id='vid_educacionFarmaceutico_clearblue_06' width='1090' height='614'></video></div>"+
	...
	/////////////////////////////////Brasil
	var educacionFarmaceutico_clearblue_06_brasil =
		//Logo
	...
	***********************************************/
	...
	switch( languageCountry )
	{
		//México
		case 1:
			document.getElementById("Container").innerHTML = generalElements + educacionFarmaceutico_clearblue_06_mexico ;
			...
			***********************************************/
			/////////////////////////////////Main Animation
			var vid_educacionFarmaceutico_clearblue_06 = document.getElementById("vid_educacionFarmaceutico_clearblue_06") ;
			...
			{
				vid_educacionFarmaceutico_clearblue_06.src = 'video/EducacionFarmaceutico/vid_educaFarma_clearblue_mex.mp4' ;
				vid_educacionFarmaceutico_clearblue_06.pause() ;
				
				if(vid_educacionFarmaceutico_clearblue_06.paused)
				{
					vid_educacionFarmaceutico_clearblue_06.play() ;
				}
			}
			
			/////////////////////////////////Exit Animation
			function exit_educacionFarmaceutico_clearblue_06_mex()
			{
				var vid_educacionFarmaceutico_clearblue_06 = document.getElementById("vid_educacionFarmaceutico_clearblue_06") ;
				vid_educacionFarmaceutico_clearblue_06.src = '' ;
			...
			***********************************************/
			...
			$('#ico_01').click(function() {
				pagChange = -2 ;
				exit_educacionFarmaceutico_clearblue_06_mex() ;
			});
			...
			$('#worlMap_icon').click(function() {
				pagChange = -1 ;
				//educacionFarmaceutico_clearblue_06.src = '' ;
				exit_educacionFarmaceutico_clearblue_06_mex() ;
			}) ;
		...
		//Brasil
		case 5:
			document.getElementById("Container").innerHTML = generalElements + educacionFarmaceutico_clearblue_06_brasil ;
			...
			***********************************************/
			...
			/////////////////////////////////Exit Animation
			function exit_educacionFarmaceutico_clearblue_06()
			{
				var noDisponible = document.getElementById("noDisponible") ;
			...
			***********************************************/
			...
			$('#ico_01').click(function() {
				pagChange = -2 ;
				exit_educacionFarmaceutico_clearblue_06() ;
			});
