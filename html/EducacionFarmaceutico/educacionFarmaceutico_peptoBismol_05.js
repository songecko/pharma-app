<!--Video Intro-->
function educacionFarmaceutico_peptoBismol_05()
{
	CleanScreen() ;
	gotoSlide = 'educacionFarmaceutico_peptoBismol_05' ;
	...
	*****************************/
	/////////////////////////////////México
	var educacionFarmaceutico_peptoBismol_05_mexico =
		//Logo
		...
		"<div class='videoContainer' id='videoContainer'>"+
			...
			//Video Screen
			"<div class='videoScreen' id='videoScreen'><video controls='controls' autoplay='autoplay' id='vid_educacionFarmaceutico_peptoBismol_05' width='1090' height='614'></video></div>"+
	...
	/////////////////////////////////Brasil
	var educacionFarmaceutico_peptoBismol_05_brasil =
		//Logo
		"<div class='peptoBismol_logoPeptoBismol' id='peptoBismol_logoPeptoBismol'><img src='img/img_logo_peptoBismol.png'></div>"+
		//Header
		"<div class='peptoBismol_header' id='peptoBismol_header'><img src='img/PeptoBismol/img_header.png'></div>"+
	...
	***********************************************/
	...
	switch( languageCountry )
	{
		//México
		case 1:
			document.getElementById("Container").innerHTML = generalElements + educacionFarmaceutico_peptoBismol_05_mexico ;
			...
			***********************************************/
			/////////////////////////////////Main Animation
			var vid_educacionFarmaceutico_peptoBismol_05 = document.getElementById("vid_educacionFarmaceutico_peptoBismol_05") ;
			...
			{
				vid_educacionFarmaceutico_peptoBismol_05.src = 'video/EducacionFarmaceutico/vid_demoMetammucil_mex.mp4' ;
				vid_educacionFarmaceutico_peptoBismol_05.pause() ;
				
				if(vid_educacionFarmaceutico_peptoBismol_05.paused)
				{
					vid_educacionFarmaceutico_peptoBismol_05.play() ;
				}
			}
			
			/////////////////////////////////Exit Animation
			function exit_educacionFarmaceutico_peptoBismol_05_mex()
			{
				var vid_educacionFarmaceutico_peptoBismol_05 = document.getElementById("vid_educacionFarmaceutico_peptoBismol_05") ;
				vid_educacionFarmaceutico_peptoBismol_05.src = '' ;
				...
				function ChangePage()
				{
					...
					{						
						...
						case 1:
							educacionFarmaceutico_peptoBismol_06() ;
						break;
					}
				}
			...
			***********************************************/
			...
			$('#ico_01').click(function() {
				pagChange = -2 ;
				exit_educacionFarmaceutico_peptoBismol_05_mex() ;
			});
			...
			$('#worlMap_icon').click(function() {
				pagChange = -1 ;
				//educacionFarmaceutico_peptoBismol_05.src = '' ;
				exit_educacionFarmaceutico_peptoBismol_05_mex() ;
			}) ;
		...
		//Brasil
		case 5:
			document.getElementById("Container").innerHTML = generalElements + educacionFarmaceutico_peptoBismol_05_brasil ;
			...
			/////////////////////////////////Exit Animation
			function exit_educacionFarmaceutico_peptoBismol_05()
			{
				var noDisponible = document.getElementById("noDisponible") ;
			...
			***********************************************/
			...
			$('#ico_01').click(function() {
				pagChange = -2 ;
				exit_educacionFarmaceutico_peptoBismol_05() ;
			});
