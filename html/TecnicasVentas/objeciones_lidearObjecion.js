<!--Video Intro-->
function objeciones_lidearObjecion()
{
	CleanScreen() ;
	gotoSlide = 'objeciones_lidearObjecion' ;
	...
	*****************************/
	var menuContent = 
		...
		"<div class='shortCuts' id='ico_06'><img src='img/icons/ico_objeciones_lidearObjecion.png' onmouseover='rollOver_ico_06()' /></div>"+
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			{
				vid_comunicacionFrente_abierta.src = 'video/TecnicasVentas/vid_objeciones_manejoObjecion.mp4' ;
			...
			/////////////////////////////////Exit Animation
			function exit_lidearObjeciones_mex()
			{
				var vid_comunicacionFrente_abierta = document.getElementById("vid_comunicacionFrente_abierta") ;
		...
		case 5:
			...
			***********************************************/
			...
			function PlayVideo()
			{
				vid_comunicacionFrente_abierta.src = 'video/TecnicasVentas/vid_objeciones_lidarObjecao.mp4' ;
				vid_comunicacionFrente_abierta.pause() ;
			...
			/////////////////////////////////Exit Animation
			function exit_lidearObjeciones()
			{
				var vid_comunicacionFrente_abierta = document.getElementById("vid_comunicacionFrente_abierta") ;
				vid_comunicacionFrente_abierta.src = '' ;
