<!--Video Intro-->
function objeciones_entenderObjecion()
{
	CleanScreen() ;
	gotoSlide = 'objeciones_entenderObjecion' ;
	...
	*****************************/
	var menuContent = 
		...
		"<div class='shortCuts' id='ico_06'><img src='img/icons/ico_objeciones_entenderObjecion.png' onmouseover='rollOver_ico_06()' /></div>"+
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			{
				vid_comunicacionFrente_abierta.src = 'video/TecnicasVentas/vid_objeciones_entenderObjecion.mp4' ;
			...
			***********************************************/
			...
			$('#worlMap_icon').click(function() {
				pagChange = -1 ;
				//objeciones_entenderObjecion.src = '' ;
				exit_comunicacionFrente_abierta_mex() ;
			}) ;
		...
		case 5:
			...
			***********************************************/
			...
			function PlayVideo()
			{
				vid_comunicacionFrente_abierta.src = 'video/TecnicasVentas/vid_objeciones_entenderObjecao.mp4' ;
				vid_comunicacionFrente_abierta.pause() ;
