<!--Video Intro-->
function ventaPersuasiva_sugerirPasoFacil()
{
	CleanScreen() ;
	gotoSlide = 'ventaPersuasiva_sugerirPasoFacil' ;
	...
	*****************************/
	var menuContent = 
		...
		"<div class='shortCuts' id='ico_06'><img src='img/icons/ico_ventaPersuasiva_sugerirPasoFacil.png' onmouseover='rollOver_ico_06()' /></div>"+
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			{
				vid_comunicacionFrente_abierta.src = 'video/TecnicasVentas/vid_ventaPersuasiva_sugerirPasoFacil.mp4' ;
			...
			***********************************************/
			...
			$('#worlMap_icon').click(function() {
				pagChange = -1 ;
				//ventaPersuasiva_sugerirPasoFacil.src = '' ;
				exit_comunicacionFrente_abierta_mex() ;
			}) ;
		...
		case 5:
			...
			***********************************************/
			...
			function PlayVideo()
			{
				vid_comunicacionFrente_abierta.src = 'video/TecnicasVentas/vid_ventaPersuasiva_sugerirPassoFacil.mp4' ;
				vid_comunicacionFrente_abierta.pause() ;
