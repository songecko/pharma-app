<!--Video Intro-->
function comunicacionFrente_abierta()
{
	CleanScreen() ;
	gotoSlide = 'comunicacionFrente_abierta' ;
	...
	*****************************/
	var menuContent = 
		...
		"<div class='shortCuts' id='ico_06'><img src='img/icons/ico_comunicacionFrente_abierta.png' onmouseover='rollOver_ico_06()' /></div>"+
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			{
				vid_comunicacionFrente_abierta.src = 'video/TecnicasVentas/vid_comunicacionFrente_abierta.mp4' ;
			...
			***********************************************/
			...
			$('#worlMap_icon').click(function() {
				pagChange = -1 ;
				//comunicacionFrente_abierta.src = '' ;
				exit_comunicacionFrente_abierta_mex() ;
			}) ;
		...
		case 5:
			...
			***********************************************/
			...
			function PlayVideo()
			{
				vid_comunicacionFrente_abierta.src = 'video/TecnicasVentas/vid_comunicacionFrente_aberta.mp4' ;
				vid_comunicacionFrente_abierta.pause() ;
