<!--Video Intro-->
function objeciones_verificarObjecion()
{
	CleanScreen() ;
	gotoSlide = 'objeciones_verificarObjecion' ;
	...
	*****************************/
	var menuContent = 
		...
		"<div class='shortCuts' id='ico_06'><img src='img/icons/ico_objeciones_verificarObjecion.png' onmouseover='rollOver_ico_06()' /></div>"+
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			{
				vid_comunicacionFrente_abierta.src = 'video/TecnicasVentas/vid_objeciones_verificarObjecion.mp4' ;
			...
			***********************************************/
			...
			$('#worlMap_icon').click(function() {
				pagChange = -1 ;
				//objeciones_verificarObjecion.src = '' ;
				exit_comunicacionFrente_abierta_mex() ;
			}) ;
		...
		case 5:
			...
			***********************************************/
			...
			function PlayVideo()
			{
				vid_comunicacionFrente_abierta.src = 'video/TecnicasVentas/vid_objeciones_verificarObjecao.mp4' ;
				vid_comunicacionFrente_abierta.pause() ;
