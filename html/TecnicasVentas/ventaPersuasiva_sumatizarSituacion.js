<!--Video Intro-->
function ventaPersuasiva_sumatizarSituacion()
{
	CleanScreen() ;
	gotoSlide = 'ventaPersuasiva_sumatizarSituacion' ;
	...
	*****************************/
	var menuContent = 
		...
		"<div class='shortCuts' id='ico_06'><img src='img/icons/ico_ventaPersuasiva_sumatizarSituacion.png' onmouseover='rollOver_ico_06()' /></div>"+
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			{
				vid_comunicacionFrente_abierta.src = 'video/TecnicasVentas/vid_ventaPersuasiva_sumatizarSituacion.mp4' ;
			...
			/////////////////////////////////Exit Animation
			function exit_ventaPersuasiva_sumatizarSituacion_mex()
			{
				var vid_comunicacionFrente_abierta = document.getElementById("vid_comunicacionFrente_abierta") ;
			...
			***********************************************/
			...
			$('#ico_01').click(function() {
				pagChange = -2 ;
				exit_ventaPersuasiva_sumatizarSituacion_mex() ;
			});
			...
			$('#worlMap_icon').click(function() {
				pagChange = -1 ;
				//ventaPersuasiva_sumatizarSituacion.src = '' ;
				exit_ventaPersuasiva_sumatizarSituacion_mex() ;
			}) ;
		...
		case 5:
			...
			***********************************************/
			...
			function PlayVideo()
			{
				vid_comunicacionFrente_abierta.src = 'video/TecnicasVentas/vid_vendaPersuasiva_sumatizarSituacao.mp4' ;
				vid_comunicacionFrente_abierta.pause() ;
			...
			/////////////////////////////////Exit Animation
			function exit_ventaPersuasiva_sumatizarSituacion()
			{
				var vid_comunicacionFrente_abierta = document.getElementById("vid_comunicacionFrente_abierta") ;
				vid_comunicacionFrente_abierta.src = '' ;
			...
			***********************************************/
			...
			$('#ico_01').click(function() {
				pagChange = -2 ;
				exit_ventaPersuasiva_sumatizarSituacion() ;
			});
