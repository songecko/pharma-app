<!--Video Intro-->
function ventaPersuasiva_expresarIdea()
{
	CleanScreen() ;
	gotoSlide = 'ventaPersuasiva_expresarIdea' ;
	...
	*****************************/
	var menuContent = 
		...
		"<div class='shortCuts' id='ico_06'><img src='img/icons/ico_ventaPersuasiva_expresarIdea.png' onmouseover='rollOver_ico_06()' /></div>"+
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			{
				vid_comunicacionFrente_abierta.src = 'video/TecnicasVentas/vid_ventaPersuasiva_expresarIdea.mp4' ;
			...
			***********************************************/
			...
			$('#worlMap_icon').click(function() {
				pagChange = -1 ;
				//ventaPersuasiva_expresarIdea.src = '' ;
				exit_comunicacionFrente_abierta_mex() ;
			}) ;
		...
		case 5:
			...
			***********************************************/
			...
			function PlayVideo()
			{
				vid_comunicacionFrente_abierta.src = 'video/TecnicasVentas/vid_ventaPersuasiva_expresarIdeia.mp4' ;
				vid_comunicacionFrente_abierta.pause() ;
