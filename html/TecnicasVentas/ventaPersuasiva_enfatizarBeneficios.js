<!--Video Intro-->
function ventaPersuasiva_enfatizarBeneficios()
{
	CleanScreen() ;
	gotoSlide = 'ventaPersuasiva_enfatizarBeneficios' ;
	...
	*****************************/
	var menuContent = 
		...
		"<div class='shortCuts' id='ico_06'><img src='img/icons/ico_ventaPersuasiva_enfatizarBeneficios.png' onmouseover='rollOver_ico_06()' /></div>"+
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			{
				vid_comunicacionFrente_abierta.src = 'video/TecnicasVentas/vid_ventaPersuasiva_enfatizarBeneficios.mp4' ;
			...
			/////////////////////////////////Exit Animation
			function exit_ventaPersuasiva_enfatizarBeneficios_mex()
			{
				var vid_comunicacionFrente_abierta = document.getElementById("vid_comunicacionFrente_abierta") ;
			...
			***********************************************/
			...
			$('#ico_01').click(function() {
				pagChange = -2 ;
				exit_ventaPersuasiva_enfatizarBeneficios_mex() ;
			});
			...
			$('#worlMap_icon').click(function() {
				pagChange = -1 ;
				//ventaPersuasiva_enfatizarBeneficios.src = '' ;
				exit_ventaPersuasiva_enfatizarBeneficios_mex() ;
			}) ;
		...
		case 5:
			...
			***********************************************/
			...
			function PlayVideo()
			{
				vid_comunicacionFrente_abierta.src = 'video/TecnicasVentas/vid_ventaPersuasiva_enfatizarBeneficios_bra.mp4' ;
				vid_comunicacionFrente_abierta.pause() ;
			...
			/////////////////////////////////Exit Animation
			function exit_ventaPersuasiva_enfatizarBeneficios()
			{
				var vid_comunicacionFrente_abierta = document.getElementById("vid_comunicacionFrente_abierta") ;
				vid_comunicacionFrente_abierta.src = '' ;
			...
			***********************************************/
			...
			$('#ico_01').click(function() {
				pagChange = -2 ;
				exit_ventaPersuasiva_enfatizarBeneficios() ;
			});
