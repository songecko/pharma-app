<!--Video Intro-->
function ventaPersuasiva_explicarFuncion()
{
	CleanScreen() ;
	gotoSlide = 'ventaPersuasiva_explicarFuncion' ;
	...
	*****************************/
	var menuContent = 
		...
		"<div class='shortCuts' id='ico_06'><img src='img/icons/ico_ventaPersuasiva_explicarFuncion.png' onmouseover='rollOver_ico_06()' /></div>"+
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			{
				vid_comunicacionFrente_abierta.src = 'video/TecnicasVentas/vid_ventaPersuasiva_explicarFuncion.mp4' ;
			...
			/////////////////////////////////Exit Animation
			function exit_ventaPersuasiva_explicarFuncion_mex()
			{
				var vid_comunicacionFrente_abierta = document.getElementById("vid_comunicacionFrente_abierta") ;
			...
			***********************************************/
			...
			$('#ico_01').click(function() {
				pagChange = -2 ;
				exit_ventaPersuasiva_explicarFuncion_mex() ;
			});
			...
			$('#worlMap_icon').click(function() {
				pagChange = -1 ;
				//ventaPersuasiva_explicarFuncion.src = '' ;
				exit_ventaPersuasiva_explicarFuncion_mex() ;
			}) ;
		...
		case 5:
			...
			***********************************************/
			...
			function PlayVideo()
			{
				vid_comunicacionFrente_abierta.src = 'video/TecnicasVentas/vid_ventaPersuasiva_explicarFunciona.mp4' ;
				vid_comunicacionFrente_abierta.pause() ;
			...
			/////////////////////////////////Exit Animation
			function exit_ventaPersuasiva_explicarFuncion()
			{
				var vid_comunicacionFrente_abierta = document.getElementById("vid_comunicacionFrente_abierta") ;
				vid_comunicacionFrente_abierta.src = '' ;
			...
			***********************************************/
			...
			$('#ico_01').click(function() {
				pagChange = -2 ;
				exit_ventaPersuasiva_explicarFuncion() ;
			});
