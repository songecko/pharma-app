<!--Menu Metamucil-->
function tec_Enfermedad_V_12()
{
	CleanScreen() ;
	
	gotoSlide = 'tec_Enfermedad_V_12' ;
	...
	*****************************/
	...
	"<div class='img05_sld_02_infoTecV_E' id='img05_sld_02_infoTecV_E'>"+
		"<img src='img/marcas/vicks/infoTec/enfer/slide12/vicks_01.png' width='390'>"+
	"</div>"+
	...
	"<div class='txt05_sld_02_infoTecV_E' id='txt05_sld_02_infoTecV_E'>"+
		...
		"Un dolor de garganta es una inflamación de la faringe y las partes circundantes.</br></br>"+

		"Por lo general, es uno de los primeros signos cuando una persona se ha resfriado o agripado.</br></br>"+
		
		"Los virus del resfriado y la gripe causan inflamación en el sitio de la infección y el dolor que acompaña es causada por esta inflamación, es lo que se siente como un dolor de garganta."+
		
	"</div>"+
		
		//Slide Number
		"<div class='slideNumber'>092</div>"+
	...
	"<div class='txt05_sld_02_infoTecV_E' id='txt05_sld_02_infoTecV_E'>"+
		...
		"A dor de garganta é uma inflamação da faringe e partes circundantes.</br></br>"+

		"Costuma ser um dos primeiros signos de que uma pessoa se resfriou ou se gripou.</br></br>"+
		
		"Os vírus do resfriado e da gripe causam inflamação no local da infecção, e a dor acompanhante causado por esta inflamação é o que se sente como dor de garganta."+
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/vick/infoTecnica/enfermedades/au_infoTecnica_enfermedades15_mx.mp3' ;
