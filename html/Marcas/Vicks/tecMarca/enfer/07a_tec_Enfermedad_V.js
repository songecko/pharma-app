<!--Menu Metamucil-->
function tec_Enfermedad_V_07a()
{
	CleanScreen() ;
	
	gotoSlide = 'tec_Enfermedad_V_07a' ;
	...
	*****************************/
	...
	"<div class='img05_sld_02_infoTecV_E' id='img05_sld_02_infoTecV_E'>"+
		"<img src='img/marcas/vicks/infoTec/enfer/slide7/vicks_02.png' width='390'>"+
	"</div>"+
	...
	"<div class='txt05_sld_02_infoTecV_E' id='txt05_sld_02_infoTecV_E'>"+
		...
		"Se ha demostrado que la gripa sobrevive:</br></br>"+
		      "• 24–48 horas sobre superficies duras no porosas, tales como acero inoxidable o plástico</br></br>"+
		      "• Hasta 15 minutos sobre tejidos o sustancias símil telas</br></br>"+
		      "• Hasta 5 minutos en las manos</br></br>"+
		      "• Un virus de la gripa puede sobrevivir durante días fuera del organismo, si se encuentra dentro de mucus"+
		
	"</div>"+
	
	//Slide Number
		"<div class='slideNumber'>085</div>"+
	...
	"<div class='txt05_sld_02_infoTecV_E' id='txt05_sld_02_infoTecV_E'>"+
		...
		"Demonstrou-se que a gripe sobrevive:</br></br>"+
		      "• 24-48 horas sobre superficies durasnão porosas, como inox ou plástico.</br></br>"+
		      "• Até 15 minutos sobre tecidos ou substâncias símile tecidos.</br></br>"+
		      "• Até 5 minuntos nas mãos.</br></br>"+
		      "• Um vírus da gripe pode sobreviver durante dias fora do organismo, se está dentro do muco."+
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/vick/infoTecnica/enfermedades/au_infoTecnica_enfermedades08_mx.mp3' ;
		...
		/**********************************************
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas/vick/au_marca_vick_infotecnica_sintomas_bra07a.mp3' ;
