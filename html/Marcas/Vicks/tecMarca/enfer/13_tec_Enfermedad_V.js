<!--Menu Metamucil-->
function tec_Enfermedad_V_13()
{
	CleanScreen() ;
	
	gotoSlide = 'tec_Enfermedad_V_13' ;
	...
	*****************************/
	...
	/////////////////////////////////Mexico
	var info11_vicksTec_Enfer_mexico =
	//Selecciona País
	"<div class='txt_Title_bullets' id='txt_Title_bullets'>Dolor de <b>garganta</b></div>"+
	...
	"<div class='img05_sld_02_infoTecV_E' id='img05_sld_02_infoTecV_E'>"+
		"<img src='img/marcas/vicks/infoTec/enfer/slide13/vicks_01.png' width='395'>"+
	"</div>"+
	...
	"</div>"+*/
		...
		//texto 2
	"<div class='txt05_sld_02_infoTecV_E' id='txt05_sld_02_infoTecV_E'>"+
				
		"Los síntomas asociados con dolor de garganta pueden ser tratados con analgésicos (calmates de dolor), anestésicos (agentes adormecedores), emulsionantes (líquido espeso como agentes que cubren la garganta), antisépticos (productos que matan las bacterias y algunas cepas virus) y hacer gárgaras con una solución salina caliente y líquidos.</br></br>"+

		"Incluye bebidas calientes y caramelos para la tos de venta libre son buenos contra el dolor de garganta,  ya que estimulan la producción de saliva y moco, ambos importantes para mantener la lubricación."+
	...
	/////////////////////////////////Brasil
	var info11_vicksTec_Enfer_brasil =
	
	//Elements
	//Selecciona País
	"<div class='txt_Title_bullets' id='txt_Title_bullets'>Dor de <b>garganta</b></div>"+
	...
	"<div class='txt05_sld_02_infoTecV_E' id='txt05_sld_02_infoTecV_E'>"+
		...
		"Os sintomas associados com inflamação da garganta podem ser tratados com analgésicos (calmates da dor),  anestésicos (agentes adormecedores), emulgentes (liquidos espessos que atuam como agentes que recobrem a garganta), anti-sépticos (produtos que matam as bactérias e algumas cepas de virus) e gargarejos de solução fisiológica morna e liquidos.</br></br>"+

		"Inclusive as bebidas quentes e as gotas para a tosse de venda livre são boas contra a dor de garganta, dado que estimulam a produçãco de saliva e muco, ambos importantes para manter lubrificação."+
	"</div>"+
	...
	***********************************************/
	...
	switch( languageCountry )
	{
		//México
		case 1:
			document.getElementById("Container").innerHTML = generalElements + info11_vicksTec_Enfer_mexico ;
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/vick/infoTecnica/enfermedades/au_infoTecnica_enfermedades16_mx.mp3' ;
		...
		//Brasil
		case 5:
			document.getElementById("Container").innerHTML = generalElements + info11_vicksTec_Enfer_brasil ;
		...
		/**********************************************
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas/vick/au_marca_vick_infotecnica_sintomas_bra11.mp3' ;
