<!--Menu Metamucil-->
function tec_Enfermedad_V_11()
{
	CleanScreen() ;
	
	gotoSlide = 'tec_Enfermedad_V_11' ;
	...
	*****************************/
	...
	"<div class='img05_sld_02_infoTecV_E' id='img05_sld_02_infoTecV_E'>"+
		"<img src='img/marcas/vicks/infoTec/enfer/slide11/vicks_01.png' width='390'>"+
	"</div>"+
	...
	"<div class='txt05_sld_02_infoTecV_E' id='txt05_sld_02_infoTecV_E'>"+
		...
		"Pero el estornudo también ayuda a difundir el resfriado y la gripe para crear gotas de aerosol que contienen el virus!</br></br>"+
		
		"Al igual que la secreción de líquido nasal, el estornudos se puede tratar con antihistamínicos de primera generación. Más en Moódulo 3!"+
		
	"</div>"+
			
			//Slide Number
		"<div class='slideNumber'>091</div>"+
	...
	"<div class='txt05_sld_02_infoTecV_E' id='txt05_sld_02_infoTecV_E'>"+
		...
		"Mas o espirro tabém ajuda a disseminar o resfrio e a gripe, ao criar gotinhas em aerossol que coteém os vírus!</br></br>"+
		
		"Igual que a secreção nasal fluÍda, o espirro pode ser tratado com antihistamínicos de primeira geração."+
	"</div>"+
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/vick/infoTecnica/enfermedades/au_infoTecnica_enfermedades14_mx.mp3' ;
