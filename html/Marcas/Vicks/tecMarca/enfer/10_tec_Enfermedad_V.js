<!--Menu Metamucil-->
function tec_Enfermedad_V_10()
{
	CleanScreen() ;
	
	gotoSlide = 'tec_Enfermedad_V_10' ;
	...
	*****************************/
	...
	/////////////////////////////////Mexico
	var info10_vicksTec_Enfer_mexico =
	...
	//Selecciona País
	"<div class='txt_Title_bullets' id='txt_Title_bullets'><b>Estornudos</b></div>"+
	...
	"<div class='img05_sld_02_infoTecV_E' id='img05_sld_02_infoTecV_E'>"+
		"<img src='img/marcas/vicks/infoTec/enfer/slide10/vicks_01.png' width='390'>"+
	"</div>"+
	...
	"<div class='txt05_sld_02_infoTecV_E' id='txt05_sld_02_infoTecV_E'>"+
		...
		"El estornudo es un reflejo protector que se produce cuando los estimulantes extenos irritan la nariz.</br></br>"+

		"Cuando el resfraido virus y la gripe, o alérgenos causan imflamação el 'nervio trigemino' en la nariz, que envía señales nerviosas al 'centro del estornudo' del tronco cerebral. Esto induce a la persona a estornudar con más frecuencia que lo haría en otros casos.</br></br>"+
		
		"Algunas personas sugieren que el salpicar es un mecanismo que ayuda a expulsar el virus de las vías respiratorias.</br></br>"+
		
	"</div>"+
	
	//Slide Number
		"<div class='slideNumber'>090</div>"+
		
				
	"" ;
	
	/////////////////////////////////Brasil
	var info10_vicksTec_Enfer_brasil =
		//Flechas anterior y siguiente
			//Anterior
		"<div class='flechaBack' id='flechaBack' onmouseover='rollOver_flechaBack()' ><img src='img/img_flecha_back.png' /></div>"+
			//Siguiente
	...
	//Elements
	//Selecciona País
	"<div class='txt_Title_bullets' id='txt_Title_bullets'><b>Espirros</b></div>"+
	...
	"<div class='txt05_sld_02_infoTecV_E' id='txt05_sld_02_infoTecV_E'>"+
		...
		"O espirro é um reflexo protetor que ocorre quando os estimulantes extenos irritam o nariz.</br></br>"+

		"Quando os vírus do resfraido e da gripe, ou os alergênicos causam a imflamação do “nervo trigêmeo” no nariz, o nervo envia sinais ao “centro do espirro”  do tronco do encéfalo. Isto induz a pessoa a espirrar com maior freqüência do que faria em outros casos.</br></br>"+
		
		"Algumas perssoas sugerem que o espirro é um mecanismo que ajuda a expelir os vírus do trato respiratorio.</br></br>"+
	...
	***********************************************/
	...
	switch( languageCountry )
	{
		//México
		case 1:
			document.getElementById("Container").innerHTML = generalElements + info10_vicksTec_Enfer_mexico ;
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/vick/infoTecnica/enfermedades/au_infoTecnica_enfermedades13_mx.mp3' ;
		...
		//Brasil
		case 5:
			document.getElementById("Container").innerHTML = generalElements + info10_vicksTec_Enfer_brasil ;
		...
		/**********************************************
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas/vick/au_marca_vick_infotecnica_sintomas_bra10.mp3' ;
