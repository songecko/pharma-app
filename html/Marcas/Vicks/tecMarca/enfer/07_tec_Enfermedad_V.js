<!--Menu Metamucil-->
function tec_Enfermedad_V_07()
{
	CleanScreen() ;
	
	gotoSlide = 'tec_Enfermedad_V_07' ;
	...
	*****************************/
	...
	/////////////////////////////////Mexico
	var info07_vicksTec_Enfer_mexico =
	//Selecciona País
	"<div class='txt_Title_bullets' id='txt_Title_bullets'>Causas de la <b>gripa</b></div>"+
	...
	"<div class='img05_sld_02_infoTecV_E' id='img05_sld_02_infoTecV_E'>"+
		"<img src='img/marcas/vicks/infoTec/enfer/slide7/vicks_01.png' width='390'>"+
	"</div>"+
	...
	"</div>"+*/
		...
		//texto 2
	"<div style='margin-left:-30px; margin-top:-70px; width:450px;'  class='txt05_sld_02_infoTecV_E' id='txt05_sld_02_infoTecV_E'>"+
	
		"La gripa es causada por un conjunto diferente de virus (virus de la gripa) que los causales del resfriado común. Por eso, un resfriado con diagnóstico de causa específica por virus de resfriado no se puede “transformar” en gripa.</br></br>"+

		"Los virus de la gripa son comúnmente transportados por el aire en las gotitas creadas cuando una persona infectada estornuda o tose. Estas gotitas luego pueden ser inhaladas por otra persona, que se puede infectar.</br></br>"+
		
		"Por lo general, los virus de la gripa no son dañinos cuando están sobre la piel de una persona (es decir cuando una persona toca una superficie con virus de la gripa). Pero si la persona luego toca los ojos, la nariz o la boca, el virus de la gripa ingresa en el tracto respiratorio.</br>"+
	"</div>"+
		
		//Slide Number
		"<div class='slideNumber'>084</div>"+
				
	"" ;
	
	
	/////////////////////////////////Brasil
	var info07_vicksTec_Enfer_brasil =
	
	//Elements
	//Selecciona País
	"<div class='txt_Title_bullets' id='txt_Title_bullets'>Causas <b>da gripe</b></div>"+
	...
	"</div>"+*/
		...
		//texto 2
	"<div style='margin-top:-80px;' class='txt05_sld_02_infoTecV_E' id='txt05_sld_02_infoTecV_E'>"+
		
		"A gripe é causada por um conjunto diferente de virus (virus da gripe) que os causadores do resfriado comum. Por isso, um resfrio com diagnóstico de causa específica por virus de resfrio não se pode “transformar” em fripe.</br></br>"+

		"Os virus da gripe usalmente são transportados pelo ar nas gotinhas criadas quando uma pessoa infectada espirra ou tosse. Estas gotinhas logo podem ser inaladas por outra pessoa, que podese contagiar.</br></br>"+
		
		"Generlamente, os vírus da gripe não são daninhos quando estão sobre a pele de uma pessoa (quer dizer quando uma pessoa toca uma superfície com vírus da gripe). Mas se essa pessoa logo toca os olhos, o nariz ou a boca, o vírus da gripe ingressa no trato respiratório.</br></br>"+
	...
	***********************************************/
	...
	switch( languageCountry )
	{
		//México
		case 1:
			document.getElementById("Container").innerHTML = generalElements + info07_vicksTec_Enfer_mexico ;
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/vick/infoTecnica/enfermedades/au_infoTecnica_enfermedades07_mx.mp3' ;
		...
		//Brasil
		case 5:
			document.getElementById("Container").innerHTML = generalElements + info07_vicksTec_Enfer_brasil ;
		...
		/**********************************************
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas/vick/au_marca_vick_infotecnica_sintomas_bra07.mp3' ;
