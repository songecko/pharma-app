<!--Menu Metamucil-->
function tec_Ingrediente_V_11()
{
	CleanScreen() ;
	
	gotoSlide = 'tec_Ingrediente_V_11' ;
	...
	*****************************/
	/////////////////////////////////Mexico
	var info11_vicks_mexico =
	
	//Selecciona País
	"<div class='txt_Title_bullets' id='txt_Title_bullets'>Anestésicos <b>tópicos</b></div>"+
	...
	"<div class='txt02_sld_09_infoTecV_A' id='txt02_sld_09_infoTecV_A'>"+
		...
		"Los anestésicos tópicos se usan para tratar el dolor de garganta. Actúan como agentes “adormecedores” por bloqueo de las señales nerviosas que intervienen en la percepción del dolor. Es una forma diferente del mecanismo de acción de los analgésicos, que alivian el dolor en lugar de adormecer una parte del organismo.</br>"+
	"</div>"+
	...
	"<div class='txt01_sld_06_infoTecV_A' id='txt01_sld_06_infoTecV_A'>"+
		...
		"Benzucaina</br>"+
		"<div class='Olivea_Light' style='line-height:4.5em; color: #FFF ;'>Fenol</div>"+
		"<div class='Olivea_Light' style='line-height:1.25em; color: #FFF ;'>Mentol</div>"+
	"</div>"+
	...
	"<div class='txt02b_sld_06_infoTecV_A' id='txt02b_sld_06_infoTecV_A'>"+
		"Grageas, comprimidos de desintegración oral, spray para la garganta"+
	"</div>"+
		//texto 2c
	"<div class='txt02c_sld_09_infoTecV_A' id='txt02c_sld_09_infoTecV_A'>"+
		"Spray para la garganta"+
	"</div>"+
		//texto 2d
	"<div class='txt02d_sld_09_infoTecV_A' id='txt02d_sld_09_infoTecV_A'>"+
		"Grageas, spray para la garganta"+
	"</div>"+
	...
	"</div>"+
		...
		//Slide Number
		"<div class='slideNumber'>077</div>"+
		
	"" ;
	
	
	/////////////////////////////////Brasil
	var info11_vicks_brasil =
	
	//Selecciona País
	"<div class='txt_Title_bullets' id='txt_Title_bullets'>Anéstesicos <b>tópicos</b></div>"+
	...
	"</div>"+
		...
		//texto 2 caja general
	"<div style='margin-top:50px; class='txt02_sld_09_infoTecV_A' id='txt02_sld_09_infoTecV_A'>"+
		"<b style='font-family: OliveaBold; color: #FFF; font-size:1.5em;'>Mecanismo de ação:</b></br>"+
		"Os anestésicos tópicos se usam para tratar a dor de garganta. Agem como agentes “adormecedores” por bloqueio dos sinais nervosos que intervem na percepção da dor. É uma forma diferetente do mecanismo de ação dos analgésicos, que aliviam a dor, em vez de adormecer uma parte do organismo.</br>"+
	"</div>"+
		
		//texto 1
	"<div style='margin-top:50px; class='txt01_sld_06_infoTecV_A' id='txt01_sld_06_infoTecV_A'>"+
	...
	"</div>"+
		...
		//texto 2
	"<div style='margin-top:50px; class='txt02_sld_06_infoTecV_A' id='txt02_sld_06_infoTecV_A'>"+
		"Formas comuns de dosagem</br>"+
	"</div>"+
		//texto 2b
	"<div style='margin-top:50px; class='txt02b_sld_06_infoTecV_A' id='txt02b_sld_06_infoTecV_A'>"+
		"Drágeas commprimidos de desintegração oral, spray para a garganta"+
	"</div>"+
		//texto 2c
	"<div style='margin-top:50px; class='txt02c_sld_09_infoTecV_A' id='txt02c_sld_09_infoTecV_A'>"+
		"Spray para a garganta"+
	"</div>"+
		//texto 2d
	"<div style='margin-top:50px; class='txt02d_sld_09_infoTecV_A' id='txt02d_sld_09_infoTecV_A'>"+
		"Drágeas, spray para a garganta"+
	"</div>"+
		
		//texto 3
	"<div style='margin-top:50px; class='txt03_sld_06_infoTecV_A' id='txt03_sld_06_infoTecV_A'>"+
	...
	***********************************************/
	...
	switch( languageCountry )
	{
		//México
		case 1:
			document.getElementById("Container").innerHTML = generalElements + info11_vicks_mexico ;
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/vick/infoTecnica/ingredientesActivos/au_infoTecnica_ingredientes14_mx.mp3' ;
		...
		//Brasil
		case 5:
			document.getElementById("Container").innerHTML = generalElements + info11_vicks_brasil ;
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas/vick/au_marca_vick_infotecnica_bra11.mp3' ;
