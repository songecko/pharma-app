<!--Menu Metamucil-->
function tec_Ingrediente_V_03()
{
	CleanScreen() ;
	
	gotoSlide = 'tec_Ingrediente_V_03' ;
	...
	*****************************/
	...
	//Elements
	//Selecciona País
	"<div class='txt_Title_bullets' id='txt_Title_bullets'>Generalidades sobre los <b>antihistamínicos</b></div>"+
	...
	"<div style='margin-top:-60px;' class='txt05_sld_02_infoTecV_E' id='txt05_sld_02_infoTecV_E'>"+
		"</br><b style='color: #FFF; font-size:1.5em;'>Descripción:</b></br>"+
		"Los antihistamínicos de primera generación contribuyen al tratamiento de la secreción nasal fluida y los estornudos causados por alergenos, virus del resfrío o virus de la gripe. Si bien los antihistamínicos de segunda generación (que causan menos somnolencia que los de primera generación) son fármacos importantes para los síntomas alérgicos, no son efectivos para reducir los síntomas del resfrío y la gripe, por lo que no se analizan en esta presentación.</br></br></br>"+
	"</div>"+
		
		//Slide Number
		"<div class='slideNumber'>070</div>"+
	...
	//Elements
	//Selecciona País
	"<div class='txt_Title_bullets' id='txt_Title_bullets'>O que são os <b>antihistamínicos?</b></div>"+
	...
	"</div>"+*/
		...
		//texto 2
	"<div style='margin-top:-60px;' class='txt05_sld_02_infoTecV_E' id='txt05_sld_02_infoTecV_E'>"+
		"</br><b style='color: #FFF; font-size:1.5em;'>Descrição:</b></br>"+
		"Os anti-histamínicos de primeira geração ajudam no tratamento da secreção nasal fluida e espirros causados por alergênicos, vírus do resfriado ou vírus da gripe. </br></br>Embora os anti-histamínicos de segunda geração (que causam menos sonolência que os de primeira geração) sejam fármacos importantes para os sintomas alérgicos, não são efetivos para reduzir os sintomas do resfriado e da gripe, por isso não são analisados nesta apresentação</br></br></br>"+		
	"</div>"+
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/vick/infoTecnica/ingredientesActivos/au_infoTecnica_ingredientes07_mx.mp3' ;
		...
		/**********************************************
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas/vick/au_marca_vick_infotecnica_bra03.mp3' ;
