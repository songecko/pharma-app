<!--Menu Metamucil-->
function tec_Ingrediente_V_10()
{
	CleanScreen() ;
	
	gotoSlide = 'tec_Ingrediente_V_10' ;
	...
	*****************************/
	...
	/////////////////////////////////Mexico
	var info10_vicks_mexico =
	
	//Selecciona País
	"<div class='txt_Title_bullets' id='txt_Title_bullets'>Analgesicos <b>tópicos</b></div>"+
	...
	"<div class='txt02_sld_09_infoTecV_A' id='txt02_sld_09_infoTecV_A'>"+
		...
		"El alcanfor es considerado un irritante y rubefaciente (causa enrojecimiento de la piel) sensorial relativamente débil. </br></br>"+
		"Al aplicar sobre la piel, el mentol dilata los vasos sanguíneos y causa sensación refrescante. Le sigue un efecto analgésico (alivio del dolor) que se cree causado por inhibición directa de ciertos receptores cutáneos del dolor.</br>"+
	"</div>"+
	...
	/*"<div class='txt02d_sld_09_infoTecV_A' id='txt02d_sld_09_infoTecV_A'>"+
		"Cmprimidos e/ou cápsulas orais"+
	"</div>"+*/
	...
	"</div>"+
		//Slide Number
		"<div class='slideNumber'>076</div>"+
	"" ;
	
	/////////////////////////////////Brasil
	var info10_vicks_brasil =
	
	//Selecciona País
	"<div class='txt_Title_bullets' id='txt_Title_bullets'>Analgésicos <b>tópicos</b></div>"+
	...
	"</div>"+
		...
		//texto 2 caja general
	"<div style='margin-top:0px;' class='txt02_sld_09_infoTecV_A' id='txt02_sld_09_infoTecV_A'>"+
		"<b style='color: #FFF; font-size:1.5em;'>Mecanismo de ação:</b></br>"+
		"A cânfora é considerada um irritante e rubefaciente (causa avermelhamento da pele) sensorial relativamente fraco.</br></br>"+
		"Ao aplicar sobre a pele, o levomentol dilata os vasos sanguíneos e causa sensação refrescante. A seguir produz um efeito analgésico (alívio da dor) que se acrerdita seja causado por inibição direta de certos receptores cutâneos da dor.</br>"+
	"</div>"+
	...
	***********************************************/
	...
	switch( languageCountry )
	{
		//México
		case 1:
			document.getElementById("Container").innerHTML = generalElements + info10_vicks_mexico ;
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/vick/infoTecnica/ingredientesActivos/au_infoTecnica_ingredientes13_mx.mp3' ;
		...
		//Brasil
		case 5:
			document.getElementById("Container").innerHTML = generalElements + info10_vicks_brasil ;
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas/vick/au_marca_vick_infotecnica_bra10.mp3' ;
