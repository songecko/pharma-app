<!--Menu Metamucil-->
function tec_Ingrediente_V_05()
{
	CleanScreen() ;
	
	gotoSlide = 'tec_Ingrediente_V_05' ;
	...
	*****************************/
	...
	"</div>"+
		...
		//img 03 Graphic
	"<div style='position:absolute; top:360px; left:690px; width:380px; height:405px;' id='img05_sld_02_infoTecV_E'>"+
		"<img src='img/marcas/vicks/infoTec/ingre/slide5/vicks_01.png' width='380'>"+
	"</div>"+
	...
	"<div style='margin-top:-80px;' class='txt05_sld_02_infoTecV_E' id='txt05_sld_02_infoTecV_E'>"+
		"<b style='color: #FFF; font-size:1.5em;'>Descripción:</b></br>"+
		"Los analgésicos son fármacos que alivian el dolor y por lo tanto pueden aliviar los síntomas del resfrío común y la gripe, tales como dolor de garganta, cefalea y molestias y dolores corporales.</br></br>"+
		"En ocasiones, estos fármacos se denominan “calmantes del dolor”. La mayoría de estos fármacos (pero no todos) también son antipiréticos, es decir, ayudan a reducir la fiebre. En cambio, los anestésicos adormecen partes del organismo en lugar de aliviar el dolor.</br></br>"+
		"En la categoría del resfrío y la gripe, se usan anestésicos tópicos para tratar el dolor de garganta y está disponibles sobre todo como spray o grageas para la garganta.</br></br></br>"+
	"</div>"+
		
		//Slide Number
		"<div class='slideNumber'>073</div>"+
		
	"" ;
	
	/////////////////////////////////Brasil
	var info05_vicks_brasil =
	
	//Elements
	//Selecciona País
	"<div class='txt_Title_bullets' id='txt_Title_bullets'>O que são os <b>analgésicos e os anestésicos?</b></div>"+
	...
	"<div style='margin-top:-60px;' class='txt05_sld_02_infoTecV_E' id='txt05_sld_02_infoTecV_E'>"+
		"<b style='color: #FFF; font-size:1.5em;'>Descrição:</b></br>"+
		"Os analgésicos são fármacos que aliviam a dor e portanto podem aliviar os sintomas do resfriado comum ed a gripe, como dor de garganta, cefaléia e moléstias e dores corporais. Ocasionalmente, estes fármacos se denominam &ldquo;calmates da dor&rdquo;. </br></br>"+
		"A maioria destes fármacos (mas não todos) também são antipiréticos, quer dizer, ajudam a reduzir a febre. Em troca, os anestésicos adormencem partes do organismo em lugar de aliviar a dor. </br></br>"+
		"Nos resfriados e na gripe, usam-se anestésicos tópicos para tratar a dor de garganta e eles estão disponíveis sobretudo como spray ou drágeas para a garganta.</br></br></br>"+
	...
	***********************************************/
	...
	switch( languageCountry )
	{
		//México
		case 1:
			document.getElementById("Container").innerHTML = generalElements + info05_vicks_mexico ;
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/vick/infoTecnica/ingredientesActivos/au_infoTecnica_ingredientes10_mx.mp3' ;
		...
		//Brasil
		case 5:
			document.getElementById("Container").innerHTML = generalElements + info05_vicks_brasil ;
		...
		/**********************************************
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas/vick/au_marca_vick_infotecnica_bra05.mp3' ;
