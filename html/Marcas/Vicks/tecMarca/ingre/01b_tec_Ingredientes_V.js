<!--Menu Vicks-->
function tec_Ingrediente_V_01b()
{
	CleanScreen() ;
	
	gotoSlide = 'tec_Ingrediente_V_01b' ;
	...
	*****************************/
	...
	//Elements
	//Selecciona País
	"<div class='txt_Title_bullets' id='txt_Title_bullets'>¿Que son los <b>expectorantes y mucolíticos?</b></div>"+
	...
	"<div class='img03_sld_14_inf_Mrc_C' id='img03_sld_14_inf_Mrc_C'>"+
		"<img src='img/marcas/vicks/infoTec/ingre/slideXt/vicks_01.png' width='475'>"+
	"</div>"+
	...
	"<div style='margin-left:-50px;' class='txt01_sld_04_inf_Tec_P' id='txt01_sld_04_inf_Tec_P'>"+
		...
		"Los expectorantes y los mucolíticos ayudan a aliviar la congestión de pecho causada por el mucus espeso y viscoso que se acumula en las vías aéreas inferiores (es decir, la tos catarral). Ayudan a licuar el mucus, que así se elimina más fácilmente de los pulmones por la tos."+
	"</div>"+
	//Slide Number
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/vick/infoTecnica/ingredientesActivos/au_infoTecnica_ingredientes02_mx.mp3' ;
