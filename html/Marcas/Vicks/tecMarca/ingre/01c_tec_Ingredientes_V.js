<!--Menu Vicks-->
function tec_Ingrediente_V_01c()
{
	CleanScreen() ;
	
	gotoSlide = 'tec_Ingrediente_V_01c' ;
	...
	*****************************/
	...
	//Selecciona País
	"<div class='txt_Title_bullets' id='txt_Title_bullets'>Expectorantes<b></b></div>"+
	...
	"<div class='img02_sld_06_infoTecV_A' id='img02_sld_06_infoTecV_A'>"+
		"<img src='img/marcas/vicks/infoTec/ingre/slideXt/vicks_03.png' />"+
	"</div>"+

		//texto 2 caja general
	"<div class='txt02_sld_09_infoTecV_A' id='txt02_sld_09_infoTecV_A'>"+
		"Mecanismo de acción: Los expectorantes incrementan la producción de fluidos pulmonares y contribuyen a licuar y hacer menos viscoso (espeso) el mucus en las vías respiratorias.</br></br>"+
		"Los expectorantes también incrementan la eficiencia de la tos y facilitan la eliminación de las secreciones respiratorias.</br>"+
	"</div>"+
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/vick/infoTecnica/ingredientesActivos/au_infoTecnica_ingredientes03_mx.mp3' ;
