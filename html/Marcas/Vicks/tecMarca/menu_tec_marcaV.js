<!--Menu InfoTec Vicks-->
function infoTec_01V()
{
	CleanScreen() ;
	
	gotoSlide = 'infoTec_01V' ;
	...
	*****************************/
	...
	/////////////////////////////////Mexico
	var menu_vicks_info_tec_mexico =
	//Selecciona País
	"<div class='img01_sld_01_infoTecH' id='img01_sld_01_infoTecH'><img src='img/marcas/vicks/bg_menuInfoTec.png' /></div>"+
	...
	/////////////////////////////////Brasil
	var menu_vicks_info_tec_brasil =
	//Selecciona País
	"<div class='img01_sld_01_infoTecH' id='img01_sld_01_infoTecH'><img src='img/marcas/vicks/bg_menuInfoTec.png' /></div>"+
	...
	***********************************************/
	...
	switch( languageCountry )
	{
		//México
		case 1:
			document.getElementById("Container").innerHTML = generalElements + menu_vicks_info_tec_mexico ;
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/vick/infoTecnica/au_menu_infoTecnica_mx.mp3' ;
		...
		//Brasil
		case 5:
			document.getElementById("Container").innerHTML = generalElements + menu_vicks_info_tec_brasil ;
		...
		***********************************************/	
		//Locution Load
			...
			auLocucion.src = 'audio/marcas/vick/au_marca_vick_menuinfotecnica_bra.mp3' ;
