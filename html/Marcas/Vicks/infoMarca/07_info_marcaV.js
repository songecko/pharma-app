...
function info_marca_07V()
{
	CleanScreen() ;
	
	gotoSlide = 'info_marca_07V' ;
	//languageCountry = 5 ;
	...
	*****************************/
	var menuContent = 
		...
		//Info Metamucil
		"<div class='shortCuts' id='ico_07'><img src='img/icons/ico_menu_infoMarcaVics_Pastilhas.png' onmouseover='rollOver_ico_07()' /></div>"+
	...
	*****************************/
	...
	var normaEvaluacion_mexico =
		//Selecciona País
		//"<div class='txt_Title_bullets' id='txt_Title_bullets'>Ficha Padrao de Avaliacao</div>"+

		//Images
			//01
		"<div class='vick_vaporru_img' id='vick_vaporru_img'><img src='img/marcas/vicks/infoMar/slide7/vicks_01_mx.png' id='norma_Image_change' /></div>"+		
...
//Slide Number
	...
	var normaEvaluacion_brasil =
		...
		//Images
			//01
		"<div class='vick_vaporru_img' id='vick_vaporru_img'><img src='img/marcas/vicks/infoMar/slide7/vicks_01.png' id='norma_Image_change' /></div>"+		
	...
	switch( languageCountry )
	{
				...
				function ChangeImage()
				{
					switch(selection)
					{
						case 1:
							...
							document.getElementById("norma_Image_change").src='img/marcas/vicks/infoMar/slide7/vicks_01_mx.png'
							...
							***********************************************/
							...
							auLocucion.src = 'audio/marcas_mx/vick/infoMarca/au_infoMarca03_Pastillas01_mx.mp3' ;
						...
						case 2:
							...
							document.getElementById("norma_Image_change").src='img/marcas/vicks/infoMar/slide7/vicks_02_mx.png'
							...
							***********************************************/
							...
							auLocucion.src = 'audio/marcas_mx/vick/infoMarca/au_infoMarca03_Pastillas02_mx.mp3' ;
						...
						case 3:
							...
							document.getElementById("norma_Image_change").src='img/marcas/vicks/infoMar/slide5/vicks_03.png'
				...
				function ChangeImage()
				{
					switch(selection)
					{
						case 1:
							...
							document.getElementById("norma_Image_change").src='img/marcas/vicks/infoMar/slide7/vicks_01.png'
		...
		***********************************************/	
		//Locution Load
			...
			auLocucion.src = 'audio/marcas/vick/au_marca_vick_infomarca_bra07a.mp3' ;
			...
			if (( auFlagLoc % 2 ) != 0)
			{
				auLocucion.play() ;
						...
						case 2:
							...
							document.getElementById("norma_Image_change").src='img/marcas/vicks/infoMar/slide7/vicks_02.png'
		...
		***********************************************/	
		//Locution Load
			...
			auLocucion.src = 'audio/marcas/vick/au_marca_vick_infomarca_bra07b.mp3' ;
