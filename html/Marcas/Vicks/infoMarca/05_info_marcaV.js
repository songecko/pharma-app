...
function info_marca_05V()
{
	CleanScreen() ;
	
	gotoSlide = 'info_marca_05V' ;
	//languageCountry = 5 ;
	...
	*****************************/
	var menuContent = 
		...
		//Info Metamucil
		"<div class='shortCuts' id='ico_07'><img src='img/icons/ico_menu_infoMarcaVics_Pirena.png' onmouseover='rollOver_ico_07()' /></div>"+
	...
	*****************************/
	...
	var normaEvaluacion_mexico =
		...
		//Images
			//01
		"<div class='vick_vaporru_img' id='vick_vaporru_img'><img src='img/marcas/vicks/infoMar/slide5/vicks_01_mx.png' id='norma_Image_change' /></div>"+		
...
//Slide Number
	...
	var normaEvaluacion_brasil =
		...
		//Images
			//01
		"<div class='vick_vaporru_img' id='vick_vaporru_img'><img src='img/marcas/vicks/infoMar/slide5/vicks_01.png' id='norma_Image_change' /></div>"+		
	...
	switch( languageCountry )
	{
		...
		case 1:
				...
				function ChangeImage()
				{
					switch(selection)
					{
						case 1:
							...
							document.getElementById("norma_Image_change").src='img/marcas/vicks/infoMar/slide5/vicks_01_mx.png'
						...
						case 2:
							...
							document.getElementById("norma_Image_change").src='img/marcas/vicks/infoMar/slide5/vicks_02_mx.png'
						...
						case 3:
							...
							document.getElementById("norma_Image_change").src='img/marcas/vicks/infoMar/slide5/vicks_03_mx.png'
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/vick/infoMarca/au_infoMarca03_Pyrena_mx.mp3' ;
		...
		case 5:
				...
				function ChangeImage()
				{
					switch(selection)
					{
						case 1:
							...
							document.getElementById("norma_Image_change").src='img/marcas/vicks/infoMar/slide5/vicks_01.png'
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas/vick/au_marca_vick_infomarca_bra05a.mp3' ;
			...
			if (( auFlagLoc % 2 ) != 0)
			{
				auLocucion.play() ;
						...
						case 2:
							...
							document.getElementById("norma_Image_change").src='img/marcas/vicks/infoMar/slide5/vicks_02.png'
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas/vick/au_marca_vick_infomarca_bra05b.mp3' ;
