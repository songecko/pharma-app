...
function info_marca_08V()
{
	CleanScreen() ;
	
	gotoSlide = 'info_marca_08V' ;
	//languageCountry = 5 ;
	...
	*****************************/
	var menuContent = 
		...
		//Info Metamucil
		"<div class='shortCuts' id='ico_07'><img src='img/icons/ico_menu_infoMarcaVics_Jarabe.png' onmouseover='rollOver_ico_07()' /></div>"+
	...
	*****************************/
	...
	var normaEvaluacion_mexico =
		...
		//Images
			//01
		"<div class='vick_vaporru_img' id='vick_vaporru_img'><img src='img/marcas/vicks/infoMar/slide8/vicks_01_mx.png' id='norma_Image_change' /></div>"+		
	...
	switch( languageCountry )
	{
				...
				function ChangeImage()
				{
					switch(selection)
					{
						case 1:
							...
							document.getElementById("norma_Image_change").src='img/marcas/vicks/infoMar/slide8/vicks_01_mx.png'
							...
							***********************************************/
							...
							auLocucion.src = 'audio/marcas_mx/vick/infoMarca/au_infoMarca03_jarabe01_mx.mp3' ;
						...
						case 2:
							...
							document.getElementById("norma_Image_change").src='img/marcas/vicks/infoMar/slide8/vicks_02_mx.png'
							...
							***********************************************/
							...
							auLocucion.src = 'audio/marcas_mx/vick/infoMarca/au_infoMarca03_jarabe02_mx.mp3' ;
		...
		case 5:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas/vick/au_marca_vick_infomarca_bra08.mp3' ;
