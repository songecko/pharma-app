...
function info_marca_06V()
{
	CleanScreen() ;
	
	gotoSlide = 'info_marca_06V' ;
	//languageCountry = 5 ;
	...
	*****************************/
	var menuContent = 
		...
		//Info Metamucil
		"<div class='shortCuts' id='ico_07'><img src='img/icons/ico_menu_infoMarcaVics_Inalador.png' onmouseover='rollOver_ico_07()' /></div>"+
	...
	*****************************/
	...
	var normaEvaluacion_mexico =
		...
		//Images
			//01
		"<div class='vick_vaporru_img' id='vick_vaporru_img'><img src='img/marcas/vicks/infoMar/slide6/vicks_01_mx.png' id='norma_Image_change' /></div>"+		
...
//Slide Number
	...
	var normaEvaluacion_brasil =
		...
		//Images
			//01
		"<div class='vick_vaporru_img' id='vick_vaporru_img'><img src='img/marcas/vicks/infoMar/slide6/vicks_01.png' id='norma_Image_change' /></div>"+		
	...
	switch( languageCountry )
	{
			...
			***********************************************/
			...
			function changeEvaluationImage_mx()
			{
				...
				function ChangeImage()
				{
					switch(selection)
					{
						case 1:
							...
							document.getElementById("norma_Image_change").src='img/marcas/vicks/infoMar/slide6/vicks_01_mx.png'
						...
						case 2:
							...
							document.getElementById("norma_Image_change").src='img/marcas/vicks/infoMar/slide6/vicks_02.png'
						...
						case 3:
							...
							document.getElementById("norma_Image_change").src='img/marcas/vicks/infoMar/slide6/vicks_03.png'
				...
				***********************************************/
				...
				auLocucion.src = 'audio/marcas_mx/vick/infoMarca/au_infoMarca03_inhalador_mx.mp3' ;
				...
				function ChangeImage()
				{
					switch(selection)
					{
						case 1:
							...
							document.getElementById("norma_Image_change").src='img/marcas/vicks/infoMar/slide6/vicks_01.png'
		...
		/**********************************************
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas/vick/au_marca_vick_infomarca_bra06.mp3' ;
