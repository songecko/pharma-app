<!--Menu Metamucil-->
function info_marca_05H()
{
	CleanScreen() ;
	
	gotoSlide = 'info_marca_05H' ;
	...
	*****************************/
	...
	var info04_hipoglos_brasil =
		//Elements
		//Selecciona País
		"<div class='txt_Title_bullets' id='txt_Title_bullets'>Entendimento <b>assaduras</b></div>"+
		...
		"</div>"+
			...
			//img 03 Grafico
		"<div style='z-index:-3;' class='img01_sld_05_inf_Mrc' id='img01_sld_05_inf_Mrc'>"+
			"<img src='img/marcas/hipoglos/infoMar/slide5/hipo_01.png' width='870'>"+
		"</div>"+
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas/hipoglos/au_marcas_Hipoglos_infoMarca_mex05.mp3' ;
		...
		case 5:
			...
			***********************************************/
			...
			var img01_sld_05_inf_Mrc = document.getElementById("img01_sld_05_inf_Mrc") ;
			TweenMax.fromTo(img01_sld_05_inf_Mrc , .5 , {css:{opacity:"0" , width:"0"}} , {css:{opacity:"1" , width:"870"}, delay:1}) ;
			...
			function exit_info04_hipoglos()
			{
				...
				var img01_sld_05_inf_Mrc = document.getElementById("img01_sld_05_inf_Mrc") ;
				TweenMax.fromTo(img01_sld_05_inf_Mrc , .5 , {css:{opacity:"1" , width:"870"}} , {css:{opacity:"0" , width:"0"}, delay:.3}) ;
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas/hipoglos/au_marcas_Hipoglos_infoMarca_bra05.mp3' ;
