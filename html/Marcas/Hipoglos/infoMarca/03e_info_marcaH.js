<!--Menu Metamucil-->
function info_marca_03He()
{
	CleanScreen() ;
	
	gotoSlide = 'info_marca_03He' ;
	...
	*****************************/
	...
	var info04_hipoglos_brasil =
		...
		"<div style='margin-top:-100px; margin-left:-50px; width:480px;' class='Olivea_Light' id='txt02_sld_04_inf_Mrc'>"+
			"<span><b style='color: #CF3C2B; font-size:1.2em;'>É importante para o creme de erupção para:</b></span></br></br>"+
			
				"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• Conter ingredientes naturais.</br></br>"+
			
				"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• Ter um BM perfume.</br></br>"+
	
				"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• Conter ingredientes medicinais.</br></br>"+
				
				"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• Conter vitaminas.</br></br>"+
				
				"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• Conter óxido de zinco.</br></br>"+
				
				"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• Hidratar a pele do meu bebê.</br></br>"+
				
				"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• Manter a pele do meu bebê macia.</br></br>"+
		"</div>"+
