<!--Menu Metamucil-->
function info_marca_07H()
{
	CleanScreen() ;
	
	gotoSlide = 'info_marca_07H' ;
	...
	*****************************/
	...
	var info04_hipoglos_brasil =
		//Elements
		//Selecciona País
		"<div class='txt_Title_bullets' id='txt_Title_bullets'>Como <b>hipoglós</b> atua?</div>"+
		...
		"<div class='img01_sld_07_inf_Mrc' id='img01_sld_07_inf_Mrc'>"+
			"<img src='img/marcas/hipoglos/infoMar/slide7/hipo_01.png' height='560'>"+
		"</div>"+
	
			//img 03 Graphic
		"<div class='img02_sld_07_inf_Mrc' id='img02_sld_07_inf_Mrc'>"+
			"<img src='img/marcas/hipoglos/infoMar/slide7/hipo_02.png' height='560'>"+
		"</div>"+
		...
		"</div>"+*/
			...
			//texto 2
		"<div class='txt02_sld_07_inf_Mrc' id='txt02_sld_07_inf_Mrc'>"+
			"Medicamento OTC</br></br>"+
	
			"Vitaminas A e D</br>"+
			"Óleo de figado de bacalhau</br>"+
			"Fragrância característica</br>"+
			"Forma camada espessa</br>"+
			"que dura até a próxima</br>"+
			"troca de fralda</br></br>"+
			
			"Versões: 45g, 90g e 135g"+
		"</div>"+
	
			//texto 
		"<div class='txt03_sld_07_inf_Mrc' id='txt03_sld_07_inf_Mrc'>"+
			"Cosmético</br></br>"+
	
			"Vitaminas A e E</br>"+
			"Óleo de Amêndoas</br>"+
			"Fragrância suave de</br>"+
			"Amêndoas</br>"+
			"Textura suave, fácil de</br>"+
			"aplicar e remover</br></br>"+
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas/hipoglos/au_marcas_Hipoglos_infoMarca_mex07.mp3' ;
		...
		case 5:
			...
			***********************************************/
			...
			var txt02_sld_07_inf_Mrc = document.getElementById("txt02_sld_07_inf_Mrc") ;
			var txt03_sld_07_inf_Mrc = document.getElementById("txt03_sld_07_inf_Mrc") ;
			TweenMax.staggerFromTo ([txt02_sld_07_inf_Mrc, txt03_sld_07_inf_Mrc], .5 , {css:{opacity:"0" , transform:"scale(1.5,1.5)"}} , {css:{opacity:"1" , transform:"scale(1,1)"}, delay:1.4 } , .2 ) ;
			...
			function exit_info04_hipoglos()
			{
				var txt02_sld_07_inf_Mrc = document.getElementById("txt02_sld_07_inf_Mrc") ;
				var txt03_sld_07_inf_Mrc = document.getElementById("txt03_sld_07_inf_Mrc") ;
				TweenMax.staggerFromTo ([txt02_sld_07_inf_Mrc, txt03_sld_07_inf_Mrc], .5 , {css:{opacity:"1" , transform:"scale(1,1)"}} , {css:{opacity:"0" , transform:"scale(1.5,1.5)"}, delay:0 } , .2 ) ;
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas/hipoglos/au_marcas_Hipoglos_infoMarca_bra07.mp3' ;
