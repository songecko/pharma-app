<!--Menu Metamucil-->
function info_marca_03Ha()
{
	CleanScreen() ;
	
	gotoSlide = 'info_marca_03Ha' ;
	...
	*****************************/
	...
	var info04_hipoglos_brasil =
		//Elements
		//Selecciona País
		"<div class='txt_Title_bullets' id='txt_Title_bullets'>Cremes erupção <b>segmentação</b></div>"+
		...
		"<div class='img03_sld_04_inf_Mrc' id='img03_sld_04_inf_Mrc'>"+
			"<img src='img/marcas/hipoglos/infoMar/slide4/hipo_01.png' width='358'>"+
		"</div>"+
		...
		"</div>"+*/
			...
			//texto 2
		"<div style='margin-top:-100px; margin-left:-50px; width:550px;' class='Olivea_Light' id='txt02_sld_04_inf_Mrc'>"+
			"<span><b style='color: #CF3C2B; font-size:1.2em;'>Objetivo Estratégico</b></span></br>"+
			
				"Mães com bebês (com controle esfincteriano até o estágio pré-natal), que a confiança na proteção e tratamento, tanto da pele de seus bebês, bem como produtos com confiança.</br></br>"+
			
			"<span><b style='color: #CF3C2B; font-size:1.2em;'>Primeiro perspectiva Hipoglós MB</b></span></br>"+	
				"Apanhador eficácia tradicional</br></br>"+
	
			"<span><b style='color: #CF3C2B; font-size:1.2em;'>Primeiro perspectiva Almond óleo Hipoglós</b></span></br>"+	
				"Valor Adicionado apanhador Benefit"+
		"</div>"+
