<!--Menu Metamucil-->
function info_marca_03Hc()
{
	CleanScreen() ;
	
	gotoSlide = 'info_marca_03Hc' ;
	...
	*****************************/
	...
	var info04_hipoglos_brasil =
		...
		"<div class='img03_sld_04_inf_Mrc' id='img03_sld_04_inf_Mrc'>"+
			"<img src='img/marcas/hipoglos/infoMar/slide3abcde/hipo_01.png' width='358'>"+
		"</div>"+
		...
		//Preguntar sobre Apanhador?
		
		
			//texto 2
		"<div style='margin-top:-100px; margin-left:-50px; width:480px;' class='Olivea_Light' id='txt02_sld_04_inf_Mrc'>"+
			"<span><b style='color: #CF3C2B; font-size:1.2em;'>É importante para o creme de erupção:</b></span></br></br>"+
			
				"• Oferecer tanta proteção que meu bebê não vai ter erupção cutânea, não importa o tipo de fraldas usadas.</br></br>"+
			
				"• Oferecer proteção de longa duração.</br></br>"+
	
				"• Proteger a pele do meu bebê.</br></br>"+
				
				"• Ter ação rápida / proporcionar alívio rápido.</br></br>"+
				
				"• Erupção Cure.</br></br>"+
				
				"• Manter a pele do meu bebê saudável.</br></br>"+
		"</div>"+
