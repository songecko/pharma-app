<!--Menu Metamucil-->
function info_marca_03Hb()
{
	CleanScreen() ;
	
	gotoSlide = 'info_marca_03Hb' ;
	...
	*****************************/
	...
	var info04_hipoglos_brasil =
		...
		"</div>"+*/
			...
			//texto 2
		"<div style='margin-top:-100px; margin-left:-50px; width:450px;' class='Olivea_Light' id='txt02_sld_04_inf_Mrc'>"+
			"<span><b style='color: #CF3C2B; font-size:1.2em;'>Mais mães tradicionais:</b></span></br></br>"+
			
				"• Sendo um produto para as mães modernas é menos importante.</br></br>"+
			
				"• O meu papel de mãe é mais importante do que a minha profissão.</br></br>"+
	
				"• Menos favorável a sacrificar seu tempo para a família para atingir objetivos pessoais"+
		"</div>"+
