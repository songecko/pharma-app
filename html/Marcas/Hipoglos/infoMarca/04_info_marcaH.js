<!--Menu Metamucil-->
function info_marca_04H()
{
	CleanScreen() ;
	
	gotoSlide = 'info_marca_04H' ;
	...
	*****************************/
	...
	var info04_hipoglos_brasil =
		//Elements
		//Selecciona País
		"<div class='txt_Title_bullets' id='txt_Title_bullets'>Consumidores <b>?</b></div>"+
		...
		"</div>"+*/
			...
			//texto 2
		"<div class='txt02_sld_04_inf_Mrc' id='txt02_sld_04_inf_Mrc'>"+
			"Mães com crianças (pré-natal ao treinamento potty) você tem confiança na proteção e tratamento de ambos: a sua pele e seu bebê com produtos de confiança?"+
		"</div>"+
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas/hipoglos/au_marcas_Hipoglos_infoMarca_mex04.mp3' ;
		...
		case 5:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas/hipoglos/au_marcas_Hipoglos_infoMarca_bra04.mp3' ;
