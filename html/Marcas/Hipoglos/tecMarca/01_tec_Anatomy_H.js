<!--Menu Metamucil-->
function tec_Anatomy_H_01()
{
	CleanScreen() ;
	
	gotoSlide = 'tec_Anatomy_H_01' ;
	...
	*****************************/
	...
	var info04_hipoglos_brasil =
		//Elements
		//Selecciona País
		"<div class='txt_Title_bullets' id='txt_Title_bullets'>Estrutura <b>da Pele</b></div>"+
		...
		"<div class='img01_sld_01_infoTecH_A' id='img01_sld_01_infoTecH_A'>"+
			"<img src='img/marcas/hipoglos/infoTec/anatomia/hipo_01.png' width='379'>"+
		"</div>"+
		...
		"<div class='txt02_sld_06_inf_Mrc' id='txt02_sld_06_inf_Mrc'>"+
			"A pele é mais que uma capa conveniente que separa o organismo do mundo externo,é o maior órgão do corpo humano, com uma gama de funções que sustentam a sobrevivência. </br></br>Da parte superior à inferior, a pele normal compreende três camadas:  Epiderme, Derme e Subcutis."+
		"</div>"+
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas/hipoglos/au_menu_infoTecnica_anatomia_mex.mp3' ;
		...
		case 5:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas/hipoglos/au_menu_infoTecnica_anatomia_bra.mp3' ;
