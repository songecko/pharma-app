<!--Menu Metamucil-->
function tec_Enfermedad_H_01()
{
	CleanScreen() ;
	
	gotoSlide = 'tec_Enfermedad_H_01' ;
	...
	*****************************/
	...
	var info04_hipoglos_brasil =
		//Elements
		//Selecciona País
		"<div class='txt_Title_bullets' id='txt_Title_bullets'>Assaduras <b></b></div>"+
		...
		"<div class='img01_sld_04_infoTecH_E' id='img01_sld_04_infoTecH_E'>"+
			"<img src='img/marcas/hipoglos/infoTec/enfermedades/slide1/hipo_01.png' width='946'>"+
		"</div>"+
		...
		"</div>"+*/
			...
			//texto 2
		"<div class='txt01_sld_01_infoTecH_E' id='txt01_sld_01_infoTecH_E'>"+
			"Assadura é uma inflamação da pele que aparece na pele coberta pela fralda. Quase todos os bebês vão apresentar assadura, pelo menos uma vez durante os primeiros três anos de vida, na maioria dos casos, entre os 9 e 12 meses de idade. "+
		"</div>"+
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas/hipoglos/au_marcas_Hipoglos_infoTecnica_sintomas_mex01.mp3' ;
		...
		case 5:
			...
			***********************************************/
			...
			var txt01_sld_01_infoTecH_E = document.getElementById("txt01_sld_01_infoTecH_E") ;
			TweenMax.staggerFromTo ([txt01_sld_01_infoTecH_E], .5 , {css:{opacity:"0" , transform:"scale(1.5,1.5)"}} , {css:{opacity:"1" , transform:"scale(1,1)"}, delay:1.4 } , .2 ) ;
		
			/////////////////////////////////Exit animation
			function exit_infoTec_Enfer_01_hipoglos()
			{
				var txt01_sld_01_infoTecH_E = document.getElementById("txt01_sld_01_infoTecH_E") ;
				TweenMax.staggerFromTo ([txt01_sld_01_infoTecH_E], .5 , {css:{opacity:"1" , transform:"scale(1,1)"}} , {css:{opacity:"0" , transform:"scale(1.5,1.5)"}, delay:0 } , .2 ) ;
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas/hipoglos/au_marcas_Hipoglos_infoTecnica_sintomas_bra01.mp3' ;
