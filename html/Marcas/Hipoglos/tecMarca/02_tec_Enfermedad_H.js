<!--Menu Metamucil-->
function tec_Enfermedad_H_02()
{
	CleanScreen() ;
	
	gotoSlide = 'tec_Enfermedad_H_02' ;
	...
	*****************************/
	...
	var info04_hipoglos_brasil =
		//Elements
		//Selecciona País
		"<div class='txt_Title_bullets' id='txt_Title_bullets'>Causas da <b>assaduras</b></div>"+
		...
		"<div class='img01_sld_04_infoTecH_E' id='img01_sld_04_infoTecH_E'>"+
			"<img src='img/marcas/hipoglos/infoTec/enfermedades/slide2/hipo_01.png' width='946'>"+
		"</div>"+
		...
		"<div class='txt01_sld_02_infoTecH_E' id='txt01_sld_02_infoTecH_E'>"+
			"Algumas das causas mais comuns de assadura que devem chamar a atenção são:</br></br>"+
	
			"&nbsp;&nbsp;&nbsp;• Irritação quando evacua</br>"+
			"&nbsp;&nbsp;&nbsp;• Irritação pela umidade do suor e da urina (inclusive as fraldas</br>"+
			"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;mais absorventes deixam um pouco de umidade)</br>"+
			"&nbsp;&nbsp;&nbsp;• Não secar bem a pele depois de trocar a fralda</br>"+
			"&nbsp;&nbsp;&nbsp;• Atrito/fricção da fralda</br>"+
			"&nbsp;&nbsp;&nbsp;• Diarreia, que pode ser causada por antibióticos</br>"+
			"&nbsp;&nbsp;&nbsp;• Mudança ou incorporação de novos alimentos"+
		"</div>"+
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas/hipoglos/au_marcas_Hipoglos_infoTecnica_sintomas_mex02.mp3' ;
		...
		case 5:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas/hipoglos/au_marcas_Hipoglos_infoTecnica_sintomas_bra02.mp3' ;
