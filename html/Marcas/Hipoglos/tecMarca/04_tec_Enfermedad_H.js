<!--Menu Metamucil-->
function tec_Enfermedad_H_04()
{
	CleanScreen() ;
	
	gotoSlide = 'tec_Enfermedad_H_04' ;
	...
	*****************************/
	...
	var metam_info_tec_ingredientes_brasil =
		//Elements
		//Selecciona País
		"<div class='txt_Title_bullets' id='txt_Title_bullets'>Barreiras <b>cutaneas</b></div>"+
		...
		"</div>"+
			...
			//img 03 Graphic
		"<div class='img01_sld_01_infoTecH_A' id='img01_sld_01_infoTecH_A'>"+
			"<img src='img/marcas/hipoglos/infoTec/enfermedades/slide4/hipo_01.png' width='379'>"+
		"</div>"+
		...
		"<div class='txt02_sld_06_inf_Mrc' id='txt02_sld_06_inf_Mrc'>"+
			"O creme de barreira é uma formulação tópica usada em ambientes industriais, médicos e esportivos para colocar uma barreira física entre a pele e os poluentes que podem irritar (dermatite de contato ou dermatite ocupacional), ou infectar a pele.</br></br>As preparações de barreira podem ser cremes, pomadas ou aerossóis que frequentemente contêm substâncias que repelem a água, tais como óxido de zinco, silicone, ou dimeticona. "+
		"</div>"+
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas/hipoglos/au_marcas_Hipoglos_infoTecnica_sintomas_mex04.mp3' ;
		...
		case 5:
			...
			***********************************************/
			...
			var img01_sld_01_infoTecH_A = document.getElementById("img01_sld_01_infoTecH_A") ;
			TweenMax.fromTo(img01_sld_01_infoTecH_A , .5 , {css:{opacity:"0" , width:"0"}} , {css:{opacity:"1" , width:"400"}, delay:1}) ;
			...
			function exit_01_ingrediente_marca_metamucil()
			{
				...
				var img01_sld_01_infoTecH_A = document.getElementById("img01_sld_01_infoTecH_A") ;
				TweenMax.fromTo(img01_sld_01_infoTecH_A , .5 , {css:{opacity:"1" , width:"400"}} , {css:{opacity:"0" , width:"0"}, delay:.3}) ;
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas/hipoglos/au_marcas_Hipoglos_infoTecnica_sintomas_bra04.mp3' ;
