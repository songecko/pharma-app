<!--Menu Metamucil-->
function info_marca_14C()
{
	CleanScreen() ;
	
	gotoSlide = 'info_marca_14C' ;
	...
	*****************************/
	...
	var info01_clearblue_mexico =
		...
		"<div class='img03_sld_14_inf_Mrc_C' id='img03_sld_14_inf_Mrc_C'>"+
			"<img src='img/marcas/clearblue/infoMar/slide14/clear_01.png' width='475'>"+
		"</div>"+
		...
		"<div style='margin-left:-50px;' class='txt02_sld_14_inf_Mrc_C' id='txt02_sld_14_inf_Mrc_C'>"+
			"<b style='color:#FFF; font-size: 1.25em;'>El ciclo menstrual</b></br></br>"+
			"Se calcula desde el primer día de sangrado hasta el día anterior al comienzo del nuevo sangrado"+
			"Los ciclos varían de mujer a mujer</br></br>"+
			
			"<b style='color:#FFF; font-size: 1.25em;'>La trayectoria del óvulo</b></br></br>"+
			
			"Si un ovulo es fertilizado, se desplaza por la Trompa de Falopio hasta el útero."+
			
			"El tiempo de implantación dentro del útero puede llegar a tardar hasta seis días; esto se denomina embarazo y el ovulo implantado comienza a crecer."+
		"</div>"+
	//Slide Number
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/clearblue/au_generalidades_generalidades_mx.mp3' ;
