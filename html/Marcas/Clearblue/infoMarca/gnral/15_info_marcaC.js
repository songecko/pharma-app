<!--Menu Metamucil-->
function info_marca_15C()
{
	CleanScreen() ;
	
	gotoSlide = 'info_marca_15C' ;
	...
	*****************************/
	...
	var info01_clearblue_mexico =
		...
		//img 01 BaseGray
		"<div class='img01_sld_14_inf_Mrc_C' id='img01_sld_14_inf_Mrc_C'>"+
			"<img src='img/marcas/clearblue/baseGray.png'>"+
		"</div>"+
		
		//img 02 Header
		"<div class='img02_sld_14_inf_Mrc_C' id='img02_sld_14_inf_Mrc_C'>"+
			"<img src='img/marcas/clearblue/head.png' height='202' >"+
		"</div>"+
	
		//img 03 Graphic
		"<div class='img03_sld_14_inf_Mrc_C' id='img03_sld_14_inf_Mrc_C'>"+
			"<img src='img/marcas/clearblue/infoMar/slide15/clear_01.png' width='475'>"+
		"</div>"+
		...
		//texto 2
		"<div style='margin-left:-50px;' class='txt02_sld_15_inf_Mrc_C' id='txt02_sld_15_inf_Mrc_C'>"+
			"<b style='color:#FFF; font-size: 1.25em;'>¿Cómo funciona?</b></br></br>"+
			"Clearblue digital,  detecta desde 25 mUI/ml de HCG (Hormona glucoproteica- hormona que se produce con el embarazo) y así se puede determinar si se está o no embarazada.</br></br>"+
	
			"Por la cantidad de presencia de esta hormona, la prueba puede detectar además, cuántas semanas de embarazo se tienen. </br></br>"+
			
			"El indicador de concepción estima el tiempo transcurrido desde que la concepción ocurrió (supone que la concepción se produjo en el día de la ovulación).</br></br>"+
			
			"El indicador de concepción trabaja en base umbrales  de los niveles de la hCG en la orina: hay tres umbrales que dan una estimación de las semanas 1-2, 2-3 y 3 o más desde la concepción. "+
		"</div>"+
	//Slide Number
		"<div class='slideNumber'>134</div>"+
	"" ;
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			//GrayRose
			var img01_sld_14_inf_Mrc_C = document.getElementById("img01_sld_14_inf_Mrc_C") ;
			TweenMax.fromTo(img01_sld_14_inf_Mrc_C , 1 , {css:{opacity:"0" , top:"233.7px" , height:"0px"}} , {css:{opacity:"1" , top:"233.7px" , height:"688px"}, delay:.8}) ;
			
			//Header
			var img02_sld_14_inf_Mrc_C = document.getElementById("img02_sld_14_inf_Mrc_C") ;
			TweenMax.fromTo(img02_sld_14_inf_Mrc_C , 1 , {css:{opacity:"0", height:"0px"}} , {css:{opacity:"1" , height:"202px"}, delay:1}) ;
			...
			var txt02_sld_15_inf_Mrc_C = document.getElementById("txt02_sld_15_inf_Mrc_C") ;
			TweenMax.staggerFromTo ([ txt02_sld_15_inf_Mrc_C], .5 , {css:{opacity:"0" , transform:"scale(.1,.1)"}} , {css:{opacity:"1" , transform:"scale(1,1)"}, delay:1.4 } , 1.3 ) ;
			...
			function exit_info01_clearblue_mex()
			{
				...
				//var txt01_sld_14_inf_Mrc_C = document.getElementById("txt01_sld_14_inf_Mrc_C") ;
				var txt02_sld_15_inf_Mrc_C = document.getElementById("txt02_sld_15_inf_Mrc_C") ;
				TweenMax.staggerFromTo ([  txt02_sld_15_inf_Mrc_C], .5 , {css:{opacity:"1" , transform:"scale(1,1)"}} , {css:{opacity:"0" , transform:"scale(.1,.1)"}, delay:0 } , 1 ) ;
				...
				//Header
				var img02_sld_14_inf_Mrc_C = document.getElementById("img02_sld_14_inf_Mrc_C") ;
				TweenMax.fromTo(img02_sld_14_inf_Mrc_C , 1 , {css:{opacity:"1", height:"202px"}} , {css:{opacity:"0" , height:"0px"}, delay:.8}) ;
				
				//GrayRose
				var img01_sld_14_inf_Mrc_C = document.getElementById("img01_sld_14_inf_Mrc_C") ;
				TweenMax.fromTo(img01_sld_14_inf_Mrc_C , 1 , {css:{opacity:"1" , top:"233.7px" , height:"688px"}} , {css:{opacity:"0" , top:"233.7px" , height:"0px"}, delay:1}) ;
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/clearblue/au_generalidades_COMOfunciona_mx.mp3' ;
