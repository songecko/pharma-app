<!--Menu Metamucil-->
function info_marca_20C()
{
	CleanScreen() ;
	
	gotoSlide = 'info_marca_20C' ;
	...
	*****************************/
	...
	var info01_clearblue_mexico =
		...
		"<div class='img03_sld_14_inf_Mrc_C' id='img03_sld_14_inf_Mrc_C'>"+
			"<img src='img/marcas/clearblue/infoMar/slide20/clear_01.png' width='475'>"+
		"</div>"+
		...
		"<div style='margin-left:-50px;' class='txt02_sld_14_inf_Mrc_C' id='txt02_sld_14_inf_Mrc_C'>"+
			"<b style='color:#FFF; font-size: 1.25em; '>¿Cómo se realiza la prueba?</b></br></br>"+
			"Sumergir la varilla de la prueba de tal forma que la punta absorbente quede bajo el flujo de orina durante 5 segundos o bien sumergir esta punta en un contenedor limpio y seco que contenga orina durante 20 segundos.</br></br>"+
			
			"Dejar reposar la prueba durante 3 minutos de forma horizontal.</br></br>"+
			
			"Transcurridos los 3 minutos, la pantalla mostrará el resultado"+
		"</div>"+
	//Slide Number
		"<div class='slideNumber'>139</div>"+
	"" ;
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/clearblue/au_generalidades_ComoseRealiza_mx.mp3' ;
