<!--Menu Metamucil-->
function info_marca_19C()
{
	CleanScreen() ;
	
	gotoSlide = 'info_marca_19C' ;
	...
	*****************************/
	...
	var info01_clearblue_mexico =
		...
		"<div class='img03_sld_14_inf_Mrc_C' id='img03_sld_14_inf_Mrc_C'>"+
			"<img src='img/marcas/clearblue/infoMar/slide19/clear_01.png' width='475'>"+
		"</div>"+
		...
		"<div style='margin-left:-50px;' class='txt02_sld_14_inf_Mrc_C' id='txt02_sld_14_inf_Mrc_C'>"+
			"<b style='color:#FFF; font-size: 1.25em;'>Recomendaciones</b></br></br>"+
			"Hacerse la prueba el primer día de retraso.</br></br>"+
			"Si no se sabe cuándo debe iniciarse el periodo, la recomendación es realizar la prueba al menos 19 días después de la última vez que se tuvo relaciones sexuales.</br></br>"+
			
			"Lo mejor es utilizar la primera orina de la mañana y no beber mucho líquido antes de realizar la prueba."+
		"</div>"+
	//Slide Number
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/clearblue/au_generalidades_Recomendaciones_mx.mp3' ;
