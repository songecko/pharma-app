<!--Menu Metamucil-->
function info_marca_21C()
{
	CleanScreen() ;
	
	gotoSlide = 'info_marca_21C' ;
	...
	*****************************/
	...
	var info01_clearblue_mexico =
		...
		//img 03 Graphic
		"<div class='img03_sld_21_inf_Mrc_C' id='img03_sld_21_inf_Mrc_C'>"+
			"<img src='img/marcas/clearblue/infoMar/slide21/clear_01.png' width='1055'>"+
		"</div>"+
		...
		//texto 2
		"<div style='margin-left:-50px;' class='txt02_sld_14_inf_Mrc_C' id='txt02_sld_14_inf_Mrc_C'>"+
			"<b style='color:#FFF; font-size: 1.25em;'>Guía de acomodo</b></br></br>"+
			"Colocar en área de pruebas de Embarazo</br>"+
			"Detrás o frente al mostrador</br></br>"+
			
			"Nuestros productos deben ocupar al menos el 26.7% del espacio de la categoría</br></br>"+
			
			"Doble ubicación: Colocar exhibición adicional en el exhibidor sobre el mostrador"+
		"</div>"+
	//Slide Number
		...
		case 1:
			...
			***********************************************/
			...
			TweenMax.fromTo(img02_sld_14_inf_Mrc_C , 1 , {css:{opacity:"0", height:"0px"}} , {css:{opacity:"1" , height:"202px"}, delay:1}) ;
				...
				//Graphics
				var img03_sld_21_inf_Mrc_C = document.getElementById("img03_sld_21_inf_Mrc_C") ;
				TweenMax.fromTo(img03_sld_21_inf_Mrc_C , .5 , {css:{opacity:"0" , width:"0px"}} , {css:{opacity:"1" , width:"1055"}, delay:1.5}) ;
			...
			var txt02_sld_14_inf_Mrc_C = document.getElementById("txt02_sld_14_inf_Mrc_C") ;
			TweenMax.staggerFromTo ([ txt02_sld_14_inf_Mrc_C], .5 , {css:{opacity:"0" , transform:"scale(.1,.1)"}} , {css:{opacity:"1" , transform:"scale(1,1)"}, delay:1.4 } , 1.3 ) ;
			...
			function exit_info01_clearblue_mex()
			{
				...
				//var txt01_sld_14_inf_Mrc_C = document.getElementById("txt01_sld_14_inf_Mrc_C") ;
				var txt02_sld_14_inf_Mrc_C = document.getElementById("txt02_sld_14_inf_Mrc_C") ;
				TweenMax.staggerFromTo ([  txt02_sld_14_inf_Mrc_C], .5 , {css:{opacity:"1" , transform:"scale(1,1)"}} , {css:{opacity:"0" , transform:"scale(.1,.1)"}, delay:0 } , 1 ) ;
				
					//Graphics
					var img03_sld_21_inf_Mrc_C = document.getElementById("img03_sld_21_inf_Mrc_C") ;
					TweenMax.fromTo(img03_sld_21_inf_Mrc_C , .5 , {css:{opacity:"1" , width:"1055"}} , {css:{opacity:"0" , width:"0px"}, delay:.2}) ;
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/clearblue/au_generalidades_GuiaAcomodo_mx.mp3' ;
