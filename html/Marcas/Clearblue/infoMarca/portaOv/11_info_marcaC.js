...
function info_marca_11C()
{
	...
	*****************************/
	...
	var info01_clearblue_mexico =
		...
		//img 03 Graphic
		"<div class='img03_sld_11_inf_Mrc_C' id='img03_sld_11_inf_Mrc_C'>"+
			"<img src='img/marcas/clearblue/infoMar/slide11/clear_01.png' width='918'>"+
		"</div>"+
		...
		case 1:
			...
			***********************************************/
			...
			TweenMax.fromTo(img02_sld_03_inf_Mrc_C , 1 , {css:{opacity:"0", height:"0px"}} , {css:{opacity:"1" , height:"202px"}, delay:1}) ;
				...
				//Graphics
				var img03_sld_11_inf_Mrc_C = document.getElementById("img03_sld_11_inf_Mrc_C") ;
				TweenMax.fromTo(img03_sld_11_inf_Mrc_C , .5 , {css:{opacity:"0" , width:"0px"}} , {css:{opacity:"1" , width:"918px"}, delay:1.5}) ;
			...
			*/
			...
			function exit_info01_clearblue_mex()
			{
				...
				*/
					//Graphics
					var img03_sld_11_inf_Mrc_C = document.getElementById("img03_sld_11_inf_Mrc_C") ;
					TweenMax.fromTo(img03_sld_11_inf_Mrc_C , .5 , {css:{opacity:"1" , width:"918px"}} , {css:{opacity:"0" , width:"0px"}, delay:.2}) ;
