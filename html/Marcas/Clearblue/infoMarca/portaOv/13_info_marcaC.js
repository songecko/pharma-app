<!--Menu Metamucil-->
function info_marca_13C()
{
	CleanScreen() ;
	
	gotoSlide = 'info_marca_13C' ;
	...
	*****************************/
	...
	var info01_clearblue_mexico =
		//Elements
		//Selecciona País
		"<div class='txt_Title_bullets' id='txt_Title_bullets'>Comparativo<b></b></div>"+
		...
		"<div class='img03_sld_13_inf_Mrc_C' id='img03_sld_13_inf_Mrc_C'>"+
			"<img src='img/marcas/clearblue/infoMar/slide13/clear_01.png' height='550'>"+
		"</div>"+
		...
		case 1:
			...
			***********************************************/
			...
			TweenMax.fromTo(img02_sld_03_inf_Mrc_C , 1 , {css:{opacity:"0", height:"0px"}} , {css:{opacity:"1" , height:"202px"}, delay:1}) ;
				...
				TweenMax.fromTo(img03_sld_13_inf_Mrc_C , .5 , {css:{opacity:"0" , height:"0px"}} , {css:{opacity:"1" , height:"550px"}, delay:1.5}) ;
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/clearblue/au_infoMarca_tablaComparativa_mx.mp3' ;
