<!--Menu Metamucil-->
function info_marca_03C()
{
	CleanScreen() ;
	
	gotoSlide = 'info_marca_03C' ;
	...
	*****************************/
	var menuContent = 
		...
		//Info Metamucil
		"<div class='shortCuts' id='ico_07'><img src='img/icons/ico_menu_clear_planifica.png' onmouseover='rollOver_ico_07()' /></div>"+		
	"" ;
	...
	*****************************/
	...
	var info01_clearblue_mexico =
		//Elements
		//Selecciona País
		"<div class='txt_Title_bullets' id='txt_Title_bullets'>Planificación <b>para un bebé</b></div>"+
		...
		"<div class='img03_sld_03_inf_Mrc_C' id='img03_sld_03_inf_Mrc_C'>"+
			"<img src='img/marcas/clearblue/infoMar/slide3/clear_01.png' width='475'>"+
		"</div>"+
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			TweenMax.staggerFromTo ([ txt01_sld_03_inf_Mrc_C, txt02_sld_03_inf_Mrc_C], .5 , {css:{opacity:"0" , transform:"scale(.1,.1)"}} , {css:{opacity:"1" , transform:"scale(1,1)"}, delay:1.4 } , 1.3 ) ;
			...
			function exit_info01_clearblue_mex()
			{
				...
				var txt01_sld_03_inf_Mrc_C = document.getElementById("txt01_sld_03_inf_Mrc_C") ;
				var txt02_sld_03_inf_Mrc_C = document.getElementById("txt02_sld_03_inf_Mrc_C") ;
				TweenMax.staggerFromTo ([ txt01_sld_03_inf_Mrc_C, txt02_sld_03_inf_Mrc_C], .5 , {css:{opacity:"1" , transform:"scale(1,1)"}} , {css:{opacity:"0" , transform:"scale(.1,.1)"}, delay:0 } , 1 ) ;
