<!--Menu Metamucil-->
function info_marca_04C()
{
	CleanScreen() ;
	
	gotoSlide = 'info_marca_04C' ;
	...
	*****************************/
	var menuContent = 
		...
		//Info Metamucil
		"<div class='shortCuts' id='ico_07'><img src='img/icons/ico_menu_clear_embarazada.png' onmouseover='rollOver_ico_07()' /></div>"+			
	"" ;
	...
	*****************************/
	...
	var info01_clearblue_mexico =
		//Elements
		//Selecciona País
		"<div class='txt_Title_bullets' id='txt_Title_bullets'>Estoy <b>embarazada</b></div>"+
		...
		"<div class='img03_sld_03_inf_Mrc_C' id='img03_sld_03_inf_Mrc_C'>"+
			"<img src='img/marcas/clearblue/infoMar/slide4/clear_01.png' width='475'>"+
		"</div>"+
		...
		//texto 2
		"<div style='margin-top:-50px;' class='txt02_sld_03_inf_Mrc_C' id='txt02_sld_03_inf_Mrc_C'>"+
			"</br></br></br>LA EXPERIENCIA DE PRUEBA DE EMBARAZO</br>"+
			"Es altamente cargada de EMOCIÓN.</br>"+
			"Y LA PREGUNTA ES FUNDAMENTAL</br>"+
			"PARA SU FUTURO.</br></br>"+
			
			"La Actitud negativa hacia el embarazo conduce a un nerviosismo tenso (79% de las mujeres).</br></br>"+
			
			"Mientras que la actitud positiva conduce a ansiedad y excitación (79% de las mujeres).</br></br>"+
			
			"El 100% de las mujeres quieren absoluta tranquilidad. En su resultado de la prueba de embarazo **</br></br>"+
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/clearblue/au_infoMarca_estoyEmbarazada_mx.mp3' ;
