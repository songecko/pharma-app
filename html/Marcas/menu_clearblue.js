<!--Menu menu_clearblue-->
function menu_clearblue()
{
	CleanScreen() ;
	
	gotoSlide = 'menu_clearblue' ;
	...
	*****************************/
	/////////////////////////////////Mexico
	var menu_clearblue_mexico =
	  //Selecciona País
		"<div class='logoMarcaCenter' id='logoMarcaCenter'><img src='img/marcas/clearblue/logo_clearblue.png' /></div>"+
		...
		"<div class='menuElement' id='btn_02_02' onmouseover='rollOver_btn_02_02()'>"+
			//Image
			"<div class='me_Image'><img src='img/MenuElements/btn_gnralmarca.png' /></div>"+
			//Shadow
			"<div class='me_Shadow'> <img src='img/MenuElements/img_buttonShadow.png' /></div>"+
		"</div>"+
		...
		"</div>"+*/
		//Slide Number
		"<div class='slideNumber'>118</div>"+
	"" ;
	
	/////////////////////////////////Brasil
	var menu_clearblue_brasil =
	...
	***********************************************/
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			document.getElementById("Container").innerHTML = generalElements + menu_clearblue_mexico ;
			...
			***********************************************/
			...
			/////////////////////////////////Exit animation
			function exit_menu_clearblue_mx()
			{
				var logoMarcaCenter = document.getElementById("logoMarcaCenter") ;
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/clearblue/au_menuClearblue_mx.mp3' ;
		...
		//Brasil
		case 5:
			document.getElementById("Container").innerHTML = generalElements + menu_clearblue_brasil ;
