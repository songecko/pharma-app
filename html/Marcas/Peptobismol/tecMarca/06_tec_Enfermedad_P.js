<!--Menu Metamucil-->
function tec_Enfermedad_P_06()
{
	CleanScreen() ;
	
	gotoSlide = 'tec_Enfermedad_P_06' ;
	...
	*****************************/
	...
	"<div class='img03_sld_14_inf_Mrc_C' id='img03_sld_14_inf_Mrc_C'>"+
		"<img src='img/marcas/peptobismol/infoTec/slide6/pepto_01.png' width='475'>"+
	"</div>"+
	...
	//texto 2
	"<div style='margin-left:-50px;' class='txt01_sld_06_inf_Tec_P' id='txt01_sld_06_inf_Tec_P'>"+
		"<b style='color:#FFF; font-size: 1.25em;'>Diarrea</b></br>"+
		"Causas: Bacterias, infecciones virales o parasitos, intolerancia a la comida, reacción a las medicinas, enfermedades intestinales.</br></br>"+
		
		"<b style='color:#FFF; font-size: 1.25em;'>Sintomas:</b>"+
		"Heces sueltas y ocuosas causadas por el aumento en la fluidez  y frecuencia de los movimientos en el intestino.</br></br>"+
		
		"<b style='color:#FFF; font-size: 1.25em;'>Indigestion</b></br>"+
		"Causas: El consumo excesivo de alimentos y bebidas. La indigestión usualmente se produce enseguida después de comer y beber, aunque algunas veces puede haber una demora entre el consumo y el proceso de indigestión.</br></br>"+
		
		"<b style='color:#FFF; font-size: 1.25em;'>Sintomas:</b>"+
		"La sensación de molestia en el estómago o pecho. Otros síntomas pueden incluir pirosis, eructos, náuseas y vómitos. Los síntomas menos comunes incluyen un gusto feo en la boca, una lengua recubierta, fatiga o cefalea.</br></br>"+
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			var txt01_sld_06_inf_Tec_P = document.getElementById("txt01_sld_06_inf_Tec_P") ;
			TweenMax.staggerFromTo ([ txt01_sld_06_inf_Tec_P], .5 , {css:{opacity:"0" , transform:"scale(.1,.1)"}} , {css:{opacity:"1" , transform:"scale(1,1)"}, delay:1.4 } , 1.3 ) ;
			...
			function exit_mx()
			{
				...
				//var txt01_sld_14_inf_Mrc_C = document.getElementById("txt01_sld_14_inf_Mrc_C") ;
				var txt01_sld_06_inf_Tec_P = document.getElementById("txt01_sld_06_inf_Tec_P") ;
				TweenMax.staggerFromTo ([  txt01_sld_06_inf_Tec_P], .5 , {css:{opacity:"1" , transform:"scale(1,1)"}} , {css:{opacity:"0" , transform:"scale(.1,.1)"}, delay:0 } , 1 ) ;
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/pepto/infoTecnica/enfermedades/au_infoTecnica_enfermedades05_mx.mp3' ;
