<!--Menu Metamucil-->
function tec_Anatomy_P_01()
{
	CleanScreen() ;
	
	gotoSlide = 'tec_Anatomy_P_01' ;
	...
	*****************************/
	...
	//Elements
	//Selecciona País
	"<div class='txt_Title_bullets' id='txt_Title_bullets'>Mecanismo de <b>acción</b></div>"+
	...
	"<div class='img03_sld_13_inf_Mrc_C' id='img03_sld_13_inf_Mrc_C'>"+
		"<img src='img/marcas/peptobismol/infoTec/slide1/pepto_03.png' height='533'>"+
	"</div>"+
		...
		case 1:
			...
			***********************************************/
			...
			TweenMax.fromTo(img02_sld_03_inf_Mrc_C , 1 , {css:{opacity:"0", height:"0px"}} , {css:{opacity:"1" , height:"202px"}, delay:1}) ;
				...
				TweenMax.fromTo(img03_sld_13_inf_Mrc_C , .5 , {css:{opacity:"0" , height:"0px"}} , {css:{opacity:"1" , height:"533px"}, delay:1.5}) ;
			...
			*/
			...
			function exit_mx()
			{
				...
				*/
					//Graphics
					var img03_sld_13_inf_Mrc_C = document.getElementById("img03_sld_13_inf_Mrc_C") ;
					TweenMax.fromTo(img03_sld_13_inf_Mrc_C , .5 , {css:{opacity:"1" , height:"533px"}} , {css:{opacity:"0" , height:"0px"}, delay:.2}) ;
