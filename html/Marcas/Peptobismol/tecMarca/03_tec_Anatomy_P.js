<!--Menu Metamucil-->
function tec_Anatomy_P_03()
{
	CleanScreen() ;
	
	gotoSlide = 'tec_Anatomy_P_03' ;
	...
	*****************************/
	...
	//Elements
	//Selecciona País
	"<div class='txt_Title_bullets' id='txt_Title_bullets'>Recubrimiento del <b>tubo digestivo - pirosis</b></div>"+
	...
	"<div style='margin-left:-50px;' class='txt01_sld_04_inf_Tec_P' id='txt01_sld_04_inf_Tec_P'>"+
		...
		"</br></br>Un número de estudios clínicos han demostrado que el BSS proporciona alivio sintomático de la pirosis.</br></br>"+
		"Sin embargo, como el BSS ha demostrado tener un efecto insignificante sobre el pH gástrico, se cree que el alivio de la pirosis/eficacia del BSS probablemente es el resultado del efecto de revestimiento en el esófago inferior y/o estómago."+
	"</div>"+
	//Slide Number
		"<div class='slideNumber'>109</div>"+
	"" ;
