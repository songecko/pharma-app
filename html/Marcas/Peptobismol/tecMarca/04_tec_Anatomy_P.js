<!--Menu Metamucil-->
function tec_Anatomy_P_04()
{
	CleanScreen() ;
	
	gotoSlide = 'tec_Anatomy_P_04' ;
	...
	*****************************/
	...
	//Elements
	//Selecciona País
	"<div class='txt_Title_bullets' id='txt_Title_bullets'>Otros efectos <b>protectores</b></div>"+
	...
	"<div style='margin-left:-50px;' class='txt01_sld_04_inf_Tec_P' id='txt01_sld_04_inf_Tec_P'>"+
		...
		"</br></br>Estudios clínicos además han demostrado que el BSS tiene ciertos efectos antioxidantes y protectores contra la irritación química que podría conducir al daño mucoso en el tubo digestivo.</br></br>"+
		"Estudios in vitro han demostrado que el BSS puede proteger las células del estómago humano de los agentes irritantes ácidos y alcalinos."+
	"</div>"+
	//Slide Number
		"<div class='slideNumber'>110</div>"+
	"" ;
