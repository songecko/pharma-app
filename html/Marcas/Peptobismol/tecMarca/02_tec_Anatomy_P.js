<!--Menu Metamucil-->
function tec_Anatomy_P_02()
{
	CleanScreen() ;
	
	gotoSlide = 'tec_Anatomy_P_02' ;
	...
	*****************************/
	...
	//Elements
	//Selecciona País
	"<div class='txt_Title_bullets' id='txt_Title_bullets'>Recubrimiento del <b>tubo digestivo</b></div>"+
	...
	"<div style='margin-left:-50px;' class='txt01_sld_04_inf_Tec_P' id='txt01_sld_04_inf_Tec_P'>"+
		...
		"El estómago contiene ácido gástrico para descomponer los alimentos.</br></br>"+
		"Este ácido sería muy cáustico para el tejido sensible en el estómago de modo que las glándulas producen una mucosa para protegerlo.</br></br>"+
		"El exceso en el comer y en el beber, ciertos fármacos y otras sustancias pueden impactar en esta capa</br></br>"+
		"Cuando el BSS ingresa al estómago, éste se une a las proteínas en la capa mucosa, aumenta su viscosidad y proporciona un efecto de revestimiento."+
	"</div>"+
	//Slide Number
		"<div class='slideNumber'>108</div>"+
	"" ;
