<!--Menu Metamucil-->
function tec_Anatomy_P_06()
{
	CleanScreen() ;
	
	gotoSlide = 'tec_Anatomy_P_06' ;
	...
	*****************************/
	...
	//Elements
	//Selecciona País
	"<div class='txt_Title_bullets' id='txt_Title_bullets'>Como trabaja <b>pepto bismol</b></div>"+
	...
	"</div>"+
		...
		//img 03 Graphic
		"<div class='img03_sld_03_inf_Tec_P' id='img03_sld_03_inf_Tec_P'>"+
			"<img src='img/marcas/peptobismol/infoTec/slide1/pepto_01.png' width='382'>"+
		"</div>"+
	
		//img 04 Graphic
		"<div class='img04_sld_03_inf_Tec_P' id='img04_sld_03_inf_Tec_P'>"+
			"<img src='img/marcas/peptobismol/infoTec/slide1/pepto_02.png' width='382'>"+
		"</div>"+
	
		/*//img 05 Graphic
		"<div class='img05_sld_03_inf_Tec_P' id='img05_sld_03_inf_Tec_P'>"+
			"<img src='img/marcas/peptobismol/infoTec/slide3/pepto_02.png' width='382'>"+
		"</div>"+
			
	//texto 1
	"<div class='txt01_sld_03_inf_Tec_P' id='txt01_sld_03_inf_Tec_P'>"+
		"</br>Pepto-Bismol Suspensión líquida es una solución multifunción que tratará 5 de los síntomas más comunes de malestar epigástrico de forma rápida y efectiva."+
	"</div>"+
	
	//texto 2
	"<div class='txt02_sld_03_inf_Tec_P' id='txt02_sld_03_inf_Tec_P'>"+
		...
		case 1:
			...
			***********************************************/
			...
			TweenMax.fromTo(img02_sld_03_inf_Mrc_C , 1 , {css:{opacity:"0", height:"0px"}} , {css:{opacity:"1" , height:"202px"}, delay:1}) ;
				...
				//Graphics
				var img03_sld_03_inf_Tec_P = document.getElementById("img03_sld_03_inf_Tec_P") ;
				TweenMax.fromTo(img03_sld_03_inf_Tec_P , .5 , {css:{opacity:"0" , width:"0px"}} , {css:{opacity:"1" , width:"382px"}, delay:1.5}) ;
				
				var img04_sld_03_inf_Tec_P = document.getElementById("img04_sld_03_inf_Tec_P") ;
				TweenMax.fromTo(img04_sld_03_inf_Tec_P , .5 , {css:{opacity:"0" , width:"0px"}} , {css:{opacity:"1" , width:"382px"}, delay:2}) ;
				
				//var img05_sld_03_inf_Tec_P = document.getElementById("img05_sld_03_inf_Tec_P") ;
				//TweenMax.fromTo(img05_sld_03_inf_Tec_P , .5 , {css:{opacity:"0" , width:"0px"}} , {css:{opacity:"1" , width:"60px"}, delay:2.5}) ;
				//Fin Graphics
			
			//Textos
			/*var txt01_sld_03_inf_Tec_P = document.getElementById("txt01_sld_03_inf_Tec_P") ;
			var txt02_sld_03_inf_Tec_P = document.getElementById("txt02_sld_03_inf_Tec_P") ;
			TweenMax.staggerFromTo ([ txt01_sld_03_inf_Tec_P, txt02_sld_03_inf_Tec_P], .5 , {css:{opacity:"0" , transform:"scale(.1,.1)"}} , {css:{opacity:"1" , transform:"scale(1,1)"}, delay:1.4 } , 1.3 ) ;
			*/
			/////////////////////////////////Exit animation
			function exit_mx()
			{
				...
				/*var txt01_sld_03_inf_Tec_P = document.getElementById("txt01_sld_03_inf_Tec_P") ;
				var txt02_sld_03_inf_Tec_P = document.getElementById("txt02_sld_03_inf_Tec_P") ;
				TweenMax.staggerFromTo ([ txt01_sld_03_inf_Tec_P, txt02_sld_03_inf_Tec_P], .5 , {css:{opacity:"1" , transform:"scale(1,1)"}} , {css:{opacity:"0" , transform:"scale(.1,.1)"}, delay:0 } , 1 ) ;
				*/
					//Graphics
					var img03_sld_03_inf_Tec_P = document.getElementById("img03_sld_03_inf_Tec_P") ;
					TweenMax.fromTo(img03_sld_03_inf_Tec_P , .5 , {css:{opacity:"1" , width:"382px"}} , {css:{opacity:"0" , width:"0px"}, delay:.2}) ;
					
					var img04_sld_03_inf_Tec_P = document.getElementById("img04_sld_03_inf_Tec_P") ;
					TweenMax.fromTo(img04_sld_03_inf_Tec_P , .5 , {css:{opacity:"1" , width:"382px"}} , {css:{opacity:"0" , width:"0px"}, delay:.4}) ;
					
					//var img05_sld_03_inf_Tec_P = document.getElementById("img05_sld_03_inf_Tec_P") ;
					//TweenMax.fromTo(img05_sld_03_inf_Tec_P , .5 , {css:{opacity:"1" , width:"60px"}} , {css:{opacity:"0" , width:"0px"}, delay:.6}) ;
					//Fin Graphics
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/pepto/infoTecnica/ingredientes/au_menu_infoTecnica_ingredientes06_mx.mp3' ;
