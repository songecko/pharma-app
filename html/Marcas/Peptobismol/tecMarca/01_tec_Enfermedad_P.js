<!--Menu Metamucil-->
function tec_Enfermedad_P_01()
{
	CleanScreen() ;
	
	gotoSlide = 'tec_Enfermedad_P_01' ;
	...
	*****************************/
	...
	"<div class='txt02_sld_03_inf_Mrc_C' id='txt02_sld_03_inf_Mrc_C'>"+
		"<span style='color:#FFF; font-size: 1.5em; line-height:1.25em; font-family: VAGRoundedBold;'>Uno o mas de lo siguiente:</br></br>"+

		"• Estrés</br>"+
		"• Habito alimenticios</br>"+
		"• Medicamentos</br>"+
		"• Toxinas del ambiente</br>"+
		"• Genético </span>"+
	"</div>"+*/
	//Slide Number
		...
		case 1:
			...
			***********************************************/
			...
			TweenMax.fromTo(img02_sld_03_inf_Mrc_C , 1 , {css:{opacity:"0", height:"0px"}} , {css:{opacity:"1" , height:"202px"}, delay:1}) ;
				...
				/*var img04_sld_03_inf_Tec_P = document.getElementById("img04_sld_03_inf_Tec_P") ;
				TweenMax.fromTo(img04_sld_03_inf_Tec_P , .5 , {css:{opacity:"0" , width:"0px"}} , {css:{opacity:"1" , width:"60px"}, delay:2.5}) ;
				//Fin Graphics*/
			...
			*/
			...
			function exit_mx()
			{
				...
				*/
					...
					/*var img04_sld_03_inf_Tec_P = document.getElementById("img04_sld_03_inf_Tec_P") ;
					TweenMax.fromTo(img04_sld_03_inf_Tec_P , .5 , {css:{opacity:"1" , width:"60px"}} , {css:{opacity:"0" , width:"0px"}, delay:.6}) ;*/
					//Fin Graphics
