<!--Menu Metamucil-->
function tec_Enfermedad_P_05()
{
	CleanScreen() ;
	
	gotoSlide = 'tec_Enfermedad_P_05' ;
	...
	*****************************/
	...
	//img 03 Graphic
	"<div class='img01_sld_05_inf_Tec_P' id='img01_sld_05_inf_Tec_P'>"+
		"<img src='img/marcas/peptobismol/infoTec/slide5/pepto_01.png' width='229'>"+
	"</div>"+

	//img 04 Graphic
	"<div class='img02_sld_05_inf_Tec_P' id='img02_sld_05_inf_Tec_P'>"+
		"<img src='img/marcas/peptobismol/infoTec/slide5/pepto_02.png' width='229'>"+
	"</div>"+

	//img 05 Graphic
	"<div class='img03_sld_05_inf_Tec_P' id='img03_sld_05_inf_Tec_P'>"+
		"<img src='img/marcas/peptobismol/infoTec/slide5/pepto_03.png' width='424'>"+
	"</div>"+
	...
	//texto 2
	"<div class='txt01_sld_05_inf_Tec_P' id='txt01_sld_05_inf_Tec_P'>"+
		"<b style='color:#FFF; font-size: 1.25em;'>Genetica</b></br></br>"+
		"Juega un rol importante en la digestion, nos da la habilidad para resistir el estres, los problemas digestivos y las enfermedades"+

	"</div>"+
	//Slide Number
		"<div class='slideNumber'>116</div>"+
	"" ;
		...
		case 1:
			...
			***********************************************/
			...
			TweenMax.fromTo(img02_sld_03_inf_Mrc_C , 1 , {css:{opacity:"0", height:"0px"}} , {css:{opacity:"1" , height:"202px"}, delay:1}) ;
				...
				//Graphics
				var img01_sld_05_inf_Tec_P = document.getElementById("img01_sld_05_inf_Tec_P") ;
				TweenMax.fromTo(img01_sld_05_inf_Tec_P , .5 , {css:{opacity:"0" , width:"0px"}} , {css:{opacity:"1" , width:"229px"}, delay:1.5}) ;
				
				var img02_sld_05_inf_Tec_P = document.getElementById("img02_sld_05_inf_Tec_P") ;
				TweenMax.fromTo(img02_sld_05_inf_Tec_P , .5 , {css:{opacity:"0" , width:"0px"}} , {css:{opacity:"1" , width:"229px"}, delay:2}) ;
				
				var img03_sld_05_inf_Tec_P = document.getElementById("img03_sld_05_inf_Tec_P") ;
				TweenMax.fromTo(img03_sld_05_inf_Tec_P , .5 , {css:{opacity:"0" , width:"0px"}} , {css:{opacity:"1" , width:"424px"}, delay:2.5}) ;
				//Fin Graphics
			
			//Textos
			//var txt01_sld_03_inf_Mrc_C = document.getElementById("txt01_sld_03_inf_Mrc_C") ;
			var txt01_sld_05_inf_Tec_P = document.getElementById("txt01_sld_05_inf_Tec_P") ;
			TweenMax.staggerFromTo ([ txt01_sld_05_inf_Tec_P], .5 , {css:{opacity:"0" , transform:"scale(.1,.1)"}} , {css:{opacity:"1" , transform:"scale(1,1)"}, delay:1.4 } , 1.3 ) ;
			...
			function exit_mx()
			{
				...
				//var txt01_sld_03_inf_Mrc_C = document.getElementById("txt01_sld_03_inf_Mrc_C") ;
				var txt01_sld_05_inf_Tec_P = document.getElementById("txt01_sld_05_inf_Tec_P") ;
				TweenMax.staggerFromTo ([  txt01_sld_05_inf_Tec_P], .5 , {css:{opacity:"1" , transform:"scale(1,1)"}} , {css:{opacity:"0" , transform:"scale(.1,.1)"}, delay:0 } , 1 ) ;
				
					//Graphics
					var img01_sld_05_inf_Tec_P = document.getElementById("img01_sld_05_inf_Tec_P") ;
					TweenMax.fromTo(img01_sld_05_inf_Tec_P , .5 , {css:{opacity:"1" , width:"229px"}} , {css:{opacity:"0" , width:"0px"}, delay:.2}) ;
					
					var img02_sld_05_inf_Tec_P = document.getElementById("img02_sld_05_inf_Tec_P") ;
					TweenMax.fromTo(img02_sld_05_inf_Tec_P , .5 , {css:{opacity:"1" , width:"229px"}} , {css:{opacity:"0" , width:"0px"}, delay:.4}) ;
					
					var img03_sld_05_inf_Tec_P = document.getElementById("img03_sld_05_inf_Tec_P") ;
					TweenMax.fromTo(img03_sld_05_inf_Tec_P , .5 , {css:{opacity:"1" , width:"424px"}} , {css:{opacity:"0" , width:"0px"}, delay:.6}) ;
					//Fin Graphics
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/pepto/infoTecnica/enfermedades/au_infoTecnica_enfermedades04_mx.mp3' ;
