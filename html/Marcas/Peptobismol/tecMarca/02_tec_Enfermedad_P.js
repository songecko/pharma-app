<!--Menu Metamucil-->
function tec_Enfermedad_P_02()
{
	CleanScreen() ;
	
	gotoSlide = 'tec_Enfermedad_P_02' ;
	...
	*****************************/
	...
	"<div class='img03_sld_03_inf_Mrc_C' id='img03_sld_03_inf_Mrc_C'>"+
		"<img src='img/marcas/peptobismol/infoTec/slide2/pepto_01.png' width='475'>"+
	"</div>"+
	...
	"<div class='txt02_sld_03_inf_Mrc_C' id='txt02_sld_03_inf_Mrc_C'>"+
		"<b style='color:#FFF; font-size: 1.5em; line-height:1.25em;'>Uno o mas de lo siguiente:</br>"+
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/pepto/infoTecnica/enfermedades/au_infoTecnica_enfermedades01_mx.mp3' ;
