<!--Menu Metamucil-->
function tec_Enfermedad_P_04()
{
	CleanScreen() ;
	
	gotoSlide = 'tec_Enfermedad_P_04' ;
	...
	*****************************/
	...
	"<div class='img03_sld_14_inf_Mrc_C' id='img03_sld_14_inf_Mrc_C'>"+
		"<img src='img/marcas/peptobismol/infoTec/slide4/pepto_01.png' width='475'>"+
	"</div>"+
	...
	//texto 2
	"<div style='margin-left:-50px; margin-top:-30px;' class='txt01_sld_04_inf_Tec_P' id='txt01_sld_04_inf_Tec_P'>"+
		"<b style='color:#FFF; font-size: 1.25em;'>Medicamentos y Otros</b></br></br>"+
		"RX, OTC, alcohol, cafeína, etc. son toxinas para el sistema digestivo.</br></br>"+
		"Los anti-inflamatorios irritan el revestimiento del estomago impidiendo la digestión.</br></br>"+
		"Los antibióticos matan las bacterias beneficiosas naturales."+
		"Las bacterias y los parásitos  pueden dañar el sistema digestivo y liberación de toxinas. </br></br>"+
		
		"<b style='color:#FFF; font-size: 1.25em;'>Toxinas ambientales</b></br>"+
		
		"El cuerpo utiliza mucha energía para desintoxicar día a día la contaminación, los productos químicos, radiación, y aditivos alimenticios para una buena digestión."+
	"</div>"+
	//Slide Number
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/pepto/infoTecnica/enfermedades/au_infoTecnica_enfermedades03_mx.mp3' ;
