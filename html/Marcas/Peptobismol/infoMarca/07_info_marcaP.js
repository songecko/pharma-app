<!--Menu Metamucil-->
function info_marca_07P()
{
	CleanScreen() ;
	
	gotoSlide = 'info_marca_07P' ;
	...
	*****************************/
	...
	//Elements
	//Selecciona País
	"<div class='txt_Title_bullets' id='txt_Title_bullets'>Portafolio <b>actual</b></div>"+
	...
	//img 03 Graphic
	"<div style='margin-top:-175px; margin-left:-50px; width:581px; height: 666px;' class='img03_sld_03_inf_Mrc_P' id='img03_sld_03_inf_Mrc_P'>"+
		"<img src='img/marcas/peptobismol/infoMar/slide7/pepto_01.png' width='581'>"+
	"</div>"+

	//img 04 Graphic
	"<div class='img04_sld_03_inf_Mrc_P' id='img04_sld_03_inf_Mrc_P'>"+
		"<img src='img/marcas/peptobismol/infoMar/slide7/pepto_02.png' width='474'>"+
	"</div>"+
		...
		case 1:
			...
			***********************************************/
			...
			TweenMax.fromTo(img02_sld_03_inf_Mrc_C , 1 , {css:{opacity:"0", height:"0px"}} , {css:{opacity:"1" , height:"202px"}, delay:1}) ;
				...
				TweenMax.fromTo(img03_sld_03_inf_Mrc_P , .5 , {css:{opacity:"0" , width:"0px"}} , {css:{opacity:"1" , width:"581px"}, delay:1.5}) ;
			...
			function exit_mx()
			{
				...
				TweenMax.staggerFromTo ([ txt01_sld_03_inf_Mrc_C], .5 , {css:{opacity:"1" , transform:"scale(1,1)"}} , {css:{opacity:"0" , transform:"scale(.1,.1)"}, delay:0 } , 1 ) ;
					...
					//Graphics
					var img03_sld_03_inf_Mrc_P = document.getElementById("img03_sld_03_inf_Mrc_P") ;
					TweenMax.fromTo(img03_sld_03_inf_Mrc_P , .5 , {css:{opacity:"1" , width:"581px"}} , {css:{opacity:"0" , width:"0px"}, delay:.2}) ;
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/pepto/infoMarca/au_infoMarca08_mx.mp3' ;
