<!--Menu Metamucil-->
function info_marca_03P()
{
	CleanScreen() ;
	
	gotoSlide = 'info_marca_03P' ;
	...
	*****************************/
	...
	//Elements
	//Selecciona País
	"<div class='txt_Title_bullets' id='txt_Title_bullets'>Pepto-bismol <b>suspensión líquida</b></div>"+
	...
	"<div class='img03_sld_03_inf_Mrc_P' id='img03_sld_03_inf_Mrc_P'>"+
		"<img src='img/marcas/peptobismol/infoMar/slide3/pepto_01.png' width='498'>"+
	"</div>"+

	//img 04 Graphic
	"<div class='img04_sld_03_inf_Mrc_P' id='img04_sld_03_inf_Mrc_P'>"+
		"<img src='img/marcas/peptobismol/infoMar/slide3/pepto_02.png' width='474'>"+
	"</div>"+
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/pepto/infoMarca/au_infoMarca04_mx.mp3' ;
