<!--Menu Metamucil-->
function info_marca_01P()
{
	CleanScreen() ;
	
	gotoSlide = 'info_marca_01P' ;
	...
	*****************************/
	...
	//Elements
	//Selecciona País
	"<div class='txt_Title_bullets' id='txt_Title_bullets'>La <b>historia</b></div>"+
	
		//img 01 Graphic
	"<div class='img01_sld_01_inf_Mrc_C' id='img01_sld_01_inf_Mrc_C'>"+
		"<img src='img/marcas/peptobismol/infoMar/slide1/pepto_01.png' width='495'>"+
	"</div>"+
	
		//texto 1
	"<div class='txt01_sld_01_inf_Mrc_C' id='txt01_sld_01_inf_Mrc_C'>"+
		"Pepto Bismol es comercializado desde 1919 (Inicialmente su lanzamieno fue en 1894 bajo otro nombre.</br></br>"+

		"P&G adquiere  Pepto – Bismol  de Norwich Eaton en 1982.</br></br>"+
		
		"El subsalicilato  de Bismuto  (BSS) es su ingrediente activo.</br></br>"+
		
		"Alivia la acidez, indigestión, malestar estomacal, nausea  o diarrea."+
	"</div>"+
	//Slide Number
		"<div class='slideNumber'>096</div>"+
	"" ;
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/pepto/infoMarca/au_infoMarca02_mx.mp3' ;
