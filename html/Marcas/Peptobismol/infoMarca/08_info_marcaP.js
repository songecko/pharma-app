<!--Menu Metamucil-->
function info_marca_08P()
{
	CleanScreen() ;
	
	gotoSlide = 'info_marca_08P' ;
	...
	*****************************/
	...
	//Elements
	//Selecciona País
	"<div class='txt_Title_bullets' id='txt_Title_bullets'>Otros competidores <b>antidiarreicos</b></div>"+
	...
	"<div class='img03_sld_13_inf_Mrc_C' id='img03_sld_13_inf_Mrc_C'>"+
		"<img src='img/marcas/peptobismol/infoMar/slide8/pepto_01.png' height='550'>"+
	"</div>"+
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/pepto/infoMarca/au_infoMarca09_mx.mp3' ;
