<!--Menu Metamucil-->
function info_marca_09P()
{
	CleanScreen() ;
	
	gotoSlide = 'info_marca_09P' ;
	...
	*****************************/
	...
	var info01_clearblue_mexico =
		...
		//Elements
	//Selecciona País
	"<div class='txt_Title_bullets' id='txt_Title_bullets'>Otros competidores <b>antiácidos</b></div>"+
	...
	"<div class='img03_sld_13_inf_Mrc_C' id='img03_sld_13_inf_Mrc_C'>"+
		"<img src='img/marcas/peptobismol/infoMar/slide9/pepto_01.png' height='550'>"+
	"</div>"+
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/pepto/infoMarca/au_infoMarca10_mx.mp3' ;
