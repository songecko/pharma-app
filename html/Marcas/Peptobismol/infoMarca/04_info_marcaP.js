<!--Menu Metamucil-->
function info_marca_04P()
{
	CleanScreen() ;
	
	gotoSlide = 'info_marca_04P' ;
	...
	*****************************/
	...
	//Elements
	//Selecciona País
	"<div class='txt_Title_bullets' id='txt_Title_bullets'>Pepto-bismol <b>plus</b></div>"+
	...
	"<div class='img03_sld_03_inf_Mrc_P' id='img03_sld_03_inf_Mrc_P'>"+
		"<img src='img/marcas/peptobismol/infoMar/slide4/pepto_01.png' width='498'>"+
	"</div>"+

	//img 04 Graphic
	"<div class='img04_sld_03_inf_Mrc_P' id='img04_sld_03_inf_Mrc_P'>"+
		"<img src='img/marcas/peptobismol/infoMar/slide4/pepto_02.png' width='474'>"+
	"</div>"+
	...
	"<div class='txt01_sld_03_inf_Mrc_C' id='txt01_sld_03_inf_Mrc_C'>"+
		"Pepto-Bismol Plus Suspensión líquida es una solución multifunción que tratará 5 de los síntomas más comunes de malestar epigástrico de forma rápida y efectiva. Suministra alivio superior a la pirosis vs. el Pepto-Bismol original."+
	"</div>"+
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/pepto/infoMarca/au_infoMarca05_mx.mp3' ;
