<!--Menu Metamucil-->
function info_marca_05P()
{
	CleanScreen() ;
	
	gotoSlide = 'info_marca_05P' ;
	...
	*****************************/
	...
	//Elements
	//Selecciona País
	"<div class='txt_Title_bullets' id='txt_Title_bullets'>Pepto-bismol <b>comprimidos</b></div>"+
	...
	"<div class='img03_sld_03_inf_Mrc_P' id='img03_sld_03_inf_Mrc_P'>"+
		"<img src='img/marcas/peptobismol/infoMar/slide5/pepto_01.png' width='498'>"+
	"</div>"+

	//img 04 Graphic
	"<div class='img04_sld_03_inf_Mrc_P' id='img04_sld_03_inf_Mrc_P'>"+
		"<img src='img/marcas/peptobismol/infoMar/slide5/pepto_02.png' width='474'>"+
	"</div>"+
	...
	"<div class='txt01_sld_03_inf_Mrc_C' id='txt01_sld_03_inf_Mrc_C'>"+
		"Las Comprimidos de Pepto-Bismol sabor original es una solución fácil mientras se está en movimiento para aliviar la pirosis, indigestión, malestar epigástrico, náuseas, y diarrea. Disponible en cajas de 24 o 40 cápsulas"+
	"</div>"+
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/pepto/infoMarca/au_infoMarca06_mx.mp3' ;
