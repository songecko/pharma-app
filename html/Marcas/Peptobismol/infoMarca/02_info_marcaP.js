<!--Menu Metamucil-->
function info_marca_02P()
{
	CleanScreen() ;
	
	gotoSlide = 'info_marca_02P' ;
	...
	*****************************/
	...
	//Elements
	//Selecciona País
	"<div class='txt_Title_bullets' id='txt_Title_bullets'>Pepto-bismol</div>"+
	...
	//img 03 Graphic
	"<div class='img03_sld_01_inf_Mrc_P' id='img03_sld_01_inf_Mrc_P'>"+
		"<img src='img/marcas/peptobismol/infoMar/slide2/pepto_01.png' width='1030'>"+
	"</div>"+

	/*//img 04 Graphic
	"<div class='img04_sld_03_inf_Mrc_C' id='img04_sld_03_inf_Mrc_C'>"+
		"<img src='img/marcas/clearblue/infoMar/slide3/clear_02.png' width='246'>"+
	"</div>"+
	...
	//texto 1
	"<div class='txt01_sld_01_inf_Mrc_P' id='txt01_sld_01_inf_Mrc_P'>"+
		"Ingrediente Activo: Subsaliciato de Bismuto</br>"+
		"Pepto Bismol  Suspension Liquida</br>"+
		"Regular : Original & Cereza</br>"+
		"(Doble de Activo) Plus: Original</br>"+
		"Pepto Bismol Masticables</br>"+
		"Original  & Cereza</br>"+
		"Capsulas oblongas"+
	"</div>"+
	
	//texto 2
	"<div class='txt02_sld_01_inf_Mrc_P' id='txt02_sld_01_inf_Mrc_P'>"+
		"Todos proporcionan alivio efectivo a 5 o 6 de los problemas digestivos más comunes (Acidez, indigestión, malestar estomacal, naucea o diarrea)"+
	"</div>"+
	//Slide Number
		"<div class='slideNumber'>097</div>"+
	"" ;
		...
		case 1:
			...
			***********************************************/
			...
			TweenMax.fromTo(img02_sld_03_inf_Mrc_C , 1 , {css:{opacity:"0", height:"0px"}} , {css:{opacity:"1" , height:"202px"}, delay:1}) ;
				...
				//Graphics
				var img03_sld_01_inf_Mrc_P = document.getElementById("img03_sld_01_inf_Mrc_P") ;
				TweenMax.fromTo(img03_sld_01_inf_Mrc_P , .5 , {css:{opacity:"0" , width:"0px"}} , {css:{opacity:"1" , width:"1030px"}, delay:1.5}) ;
			...
			//Textos
			var txt01_sld_01_inf_Mrc_P = document.getElementById("txt01_sld_01_inf_Mrc_P") ;
			var txt02_sld_01_inf_Mrc_P = document.getElementById("txt02_sld_01_inf_Mrc_P") ;
			TweenMax.staggerFromTo ([ txt01_sld_01_inf_Mrc_P, txt02_sld_01_inf_Mrc_P], .5 , {css:{opacity:"0" , transform:"scale(.1,.1)"}} , {css:{opacity:"1" , transform:"scale(1,1)"}, delay:1.4 } , .5 ) ;
			...
			function exit_mx()
			{
				...
				var txt01_sld_01_inf_Mrc_P = document.getElementById("txt01_sld_01_inf_Mrc_P") ;
				var txt02_sld_01_inf_Mrc_P = document.getElementById("txt02_sld_01_inf_Mrc_P") ;
				TweenMax.staggerFromTo ([ txt01_sld_01_inf_Mrc_P, txt02_sld_01_inf_Mrc_P], .5 , {css:{opacity:"1" , transform:"scale(1,1)"}} , {css:{opacity:"0" , transform:"scale(.1,.1)"}, delay:0 } , 1 ) ;
				
					//Graphics
					var img03_sld_01_inf_Mrc_P = document.getElementById("img03_sld_01_inf_Mrc_P") ;
					TweenMax.fromTo(img03_sld_01_inf_Mrc_P , .5 , {css:{opacity:"1" , width:"1030px"}} , {css:{opacity:"0" , width:"0px"}, delay:.2}) ;
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/pepto/infoMarca/au_infoMarca03_mx.mp3' ;
