<!--Menu Metamucil-->
function tec_Enfermedad_marca_03a()
{
	CleanScreen() ;
	
	gotoSlide = 'tec_Enfermedad_marca_03a' ;
	...
	*****************************/
	...
	"<div class='txt02_sld_03_it_Ingr' id='txt02_sld_03_it_Ingr'>"+
		"<b style='color: #FFF; font-size:1.5em;'>Ablanda y lubrica las heces</b></br>"+

		"</br></br></br>• El psyllium absorbe grandes cantidades de agua e </br>"+
		"&nbsp;&nbsp;&nbsp;incrementa el contenido de agua de los residuos </br>"+
		"&nbsp;&nbsp;&nbsp;digestivos en el intestino, para ablandar las heces.</br></br>"+
		
		"• El gel de psyllium retiene el agua muy bien y este </br>"+
		"&nbsp;&nbsp;&nbsp;agua no puede ser fácilmente reabsorbido por el </br>"+
		"&nbsp;&nbsp;&nbsp;organismo. Esto ablanda aún más las heces.</br></br>"+
	...
	"<div class='txt02_sld_03_it_Ingr' id='txt02_sld_03_it_Ingr'>"+
		...
		"</br></br>• O psyllium absorve grandes quantidades de água e incrementa o conteúdo de água dos resíduos digestivos no intestino, para almolecer as fezes.</br></br>"+
		
		"• O gel do psyllium retém a água muita bem e esta água não pode ser facilmente reabsorvida pelo organismo.  Isto amolece ainda mais as fezes.</br></br>"+
		
		"• O gel do psyllium atua como lubrificante para facilitar o</br>"+
		"&nbsp;&nbsp;&nbsp;passo das fezes pelo intestino."+
	"</div>"+
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/metamucil/infoTecnica/enfermedades/au_infoTecnica_enfermedades06_mx.mp3' ;
