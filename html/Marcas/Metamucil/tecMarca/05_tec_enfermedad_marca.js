<!--Menu Metamucil-->
function tec_Enfermedad_marca_05()
{
	CleanScreen() ;
	
	gotoSlide = 'tec_Enfermedad_marca_05' ;
	...
	*****************************/
	...
	//Selecciona País
	"<div class='txt_Title_bullets' id='txt_Title_bullets'><b>Colesterol: </b>opciones de tratamiento</div>"+
	...
	"</div>"+
		...
		//img 02
	"<div class='img01_sld_05_it_enfer' id='img01_sld_05_it_enfer'>"+
		"<img src='img/marcas/metamucil/infoTec/enfermedades/slide5/meta_01.png' />"+
	"</div>"+	
	
		//texto 2
	"<div class='txt02_sld_03_it_Ingr' id='txt02_sld_03_it_Ingr'>"+
		
		"</br></br>• Modificaciones del estilo de vida</br>"+
		 "&nbsp;&nbsp;&nbsp;-Mantener un peso corporal saludable</br>"+
		 "&nbsp;&nbsp;&nbsp;-Consumir una dieta baja en grasas saturadas y colesterol</br>"+
		 "&nbsp;&nbsp;&nbsp;-Hacer ejercicio regularmente</br></br>"+
		
		"<b style='color: #FFF; font-size:1.5em;'>Prescripciones</b></br>"+
				
		"• Las estatinas (p.ej., Lipitor®) son los agentes más efectivos,</br>"+
		"&nbsp;&nbsp;&nbsp;dado que bloquean un paso temprano en la síntesis de colesterol </br></br>"+
							
		"• Los secuestrantes de ácidos biliares (p.ej., Questran®) se indican </br>"+
		"&nbsp;&nbsp;&nbsp;si la terapéutica con estatinas no reduce las concentraciones</br>"+
		"&nbsp;&nbsp;&nbsp;de LDL hasta el valor deseado.  No obstante, la hinchazón y la</br>"+
		"&nbsp;&nbsp;&nbsp;constipación a menudo limitan su uso.</br></br>"+
		
	
	"</div>"+
	
		//Slide Number
		"<div class='slideNumber'>046</div>"+	
	"" ;
	
	/////////////////////////////////Brasil
	var metam_info_tec_ingredientes_brasil =
	//Selecciona País
	"<div class='txt_Title_bullets' id='txt_Title_bullets'><b>Colesterol:</b> opções de tratamento</div>"+
	...
	"<div class='txt02_sld_03_it_Ingr' id='txt02_sld_03_it_Ingr'>"+
		...
		"</br></br></br>• Mudanças no estilo de vida</br>"+
		 "&nbsp;&nbsp;&nbsp;-Manter um peso corporal saudável</br>"+
		 "&nbsp;&nbsp;&nbsp;-Consumir uma dieta baixa em gorduras saturadas e colesterol</br>"+
		 "&nbsp;&nbsp;&nbsp;-Praticar exercícios regularmente</br></br>"+
		
		"• Prescrição de medicamentos</br></br>"+
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			var img01_sld_05_it_enfer = document.getElementById("img01_sld_05_it_enfer") ;
			TweenMax.fromTo(img01_sld_05_it_enfer , 1 , {css:{opacity:"0" , transform:"scale(.1,.1)"}} , {css:{opacity:"1" , transform:"scale(1,1)"}, delay:.8}) ;
			...
			function exit_mx()
			{
				...
				var img01_sld_05_it_enfer = document.getElementById("img01_sld_05_it_enfer") ;
				TweenMax.fromTo(img01_sld_05_it_enfer , 1 , {css:{opacity:"1" , transform:"scale(1,1)"}} , {css:{opacity:"0" , transform:"scale(.1,.1)"}, delay:0}) ;
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/metamucil/infoTecnica/enfermedades/au_infoTecnica_enfermedades09_mx.mp3' ;
		...
		case 5:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas/metamucil/au_marcas_metamucil_infoTecnica_enfermedad_bra05.mp3' ;
