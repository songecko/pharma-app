<!--Menu Metamucil-->
function tec_Enfermedad_marca_01()
{
	CleanScreen() ;
	
	gotoSlide = 'tec_Enfermedad_marca_01' ;
	...
	*****************************/
	...
	//Selecciona País
	"<div class='txt_Title_bullets' id='txt_Title_bullets'><b>Constipación </b>sintomas</div>"+
	...
	"<div class='txt01_sld_01_it_Ingr' id='txt01_sld_01_it_Ingr'>"+
		"Definición:</br> Dificultad para vaciar el intestino"+
	"</div>"+
	
		//texto 2
	"<div style='margin-top:-60px;' class='txt02_sld_01_it_Ingr' id='txt02_sld_01_it_Ingr'>"+
		"</br></br></br><b style='color: #FFF; font-size:1.5em;'>Sintomas</b> </br></br>"+
			"&nbsp;&nbsp;&nbsp;&nbsp;• Tensión durante los movimientos intestinales (52%)</br>"+
			"&nbsp;&nbsp;&nbsp;&nbsp;• Heces duras (44%)</br>"+
			"&nbsp;&nbsp;&nbsp;&nbsp;• Problemas de frecuencia (33%)</br>"+
			"&nbsp;&nbsp;&nbsp;&nbsp;• Urgencia improductiva (34%)</br></br>"+
	"</div>"+
			
		//Slide Number
		"<div class='slideNumber'>037</div>"+	
	"" ;
	
	/////////////////////////////////Brasil
	var metam_info_tec_ingredientes_brasil =
	//Selecciona País
	"<div class='txt_Title_bullets' id='txt_Title_bullets'><b>Constipação: </b>sintomas</div>"+
	...
	"</div>"+	
		...
		//texto 1
	"<div class='txt01_sld_01_it_Ingr' id='txt01_sld_01_it_Ingr'>"+
		"Dificuldade para esvaziar o intestino devido a</br>"+
		"absorção excessiva de água no intestino"+
	"</div>"+
	...
	"<div class='txt02_sld_01_it_Ingr' id='txt02_sld_01_it_Ingr'>"+
		"</br></br></br><b style='color: #FFF; font-size:1.5em;'>Sintomas</b> </br></br>"+
			...
			"&nbsp;&nbsp;&nbsp;&nbsp;• tensão durante os movimentos intestinais</br>"+
			"&nbsp;&nbsp;&nbsp;&nbsp;• fezes duras</br>"+
			"&nbsp;&nbsp;&nbsp;&nbsp;• problemas de frequência ao banheiro</br>"+
			"&nbsp;&nbsp;&nbsp;&nbsp;• urgência improdutiva</br></br>"+
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/metamucil/infoTecnica/enfermedades/au_infoTecnica_enfermedades01_mx.mp3' ;
		...
		case 5:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas/metamucil/au_marcas_metamucil_infoTecnica_enfermedad_bra01.mp3' ;
