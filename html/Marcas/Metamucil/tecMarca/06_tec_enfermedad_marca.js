<!--Menu Metamucil-->
function tec_Enfermedad_marca_06()
{
	CleanScreen() ;
	
	gotoSlide = 'tec_Enfermedad_marca_06' ;
	...
	*****************************/
	...
	//Selecciona País
	"<div class='txt_Title_bullets' id='txt_Title_bullets'><b>Glucemia</b> regulación</div>"+
	...
	"</div>"+
		...
		//img 02
	"<div style='margin-bottom:180px; margin-right:-280px;' class='img01_sld_06_it_enfer' id='img01_sld_06_it_enfer'>"+
		"<img src='img/marcas/metamucil/infoTec/enfermedades/slide6/meta_03.png' width='450'/>"+
	"</div>"+	
	...
	"</div>"+
		...
		//texto 2
	"<div style='width:400px;' class='txt02_sld_03_it_Ingr' id='txt02_sld_03_it_Ingr'>"+
		
		"</br></br>• La tolerancia a la glucosa se mantiene debido a la acción coordinada del hígado </br>que libera glucosa entre comidas</br></br>"+
		
		"• El hígado absorbe glucosa después de una comida</br></br>"+
		
		"• El páncreas libera insulina en respuesta a la concentración creciente de glucosa en la sangre</br></br>"+
		
		"• La glucosa es captada por los tejidos corporales (p.ej., muscular y adiposo)."+
	...
	//Selecciona País
	"<div class='txt_Title_bullets' id='txt_Title_bullets'>Regulação da <b>glicemia</b></div>"+
	...
	"</div>"+
		...
		//img 02
	"<div style='margin-bottom:180px; margin-right:-280px;' class='img01_sld_06_it_enfer' id='img01_sld_06_it_enfer'>"+
		"<img src='img/marcas/metamucil/infoTec/enfermedades/slide6/meta_02.png' width='450'/>"+
	"</div>"+	
	...
	"<div style='width:400px;' class='txt02_sld_03_it_Ingr' id='txt02_sld_03_it_Ingr'>"+
		...
		"</br></br>• A tolerância à glicose se mantém devido à ação coordenada do fígado</br> que libera glicose entre refeições</br></br>"+
		
		"• O fígado absorve glicose depois de uma refeição</br></br>"+
		
		"• O pâncreas libera insulina como resposta à concentração crescente de glicose no sangue</br></br>"+
		
		"• A glicose é captada pelos tecidos corporais (p.ex., muscular e adiposo)."+
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			var img01_sld_06_it_enfer = document.getElementById("img01_sld_06_it_enfer") ;
			TweenMax.fromTo(img01_sld_06_it_enfer , 1 , {css:{opacity:"0" , transform:"scale(.1,.1)"}} , {css:{opacity:"1" , transform:"scale(1,1)"}, delay:.8}) ;
			...
			function exit_mx()
			{
				...
				var img01_sld_06_it_enfer = document.getElementById("img01_sld_06_it_enfer") ;
				TweenMax.fromTo(img01_sld_06_it_enfer , 1 , {css:{opacity:"1" , transform:"scale(1,1)"}} , {css:{opacity:"0" , transform:"scale(.1,.1)"}, delay:0}) ;
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/metamucil/infoTecnica/enfermedades/au_infoTecnica_enfermedades12_mx.mp3' ;
		...
		case 5:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas/metamucil/au_marcas_metamucil_infoTecnica_enfermedad_bra06.mp3' ;
