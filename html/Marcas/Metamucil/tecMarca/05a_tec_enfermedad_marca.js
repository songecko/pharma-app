<!--Menu Metamucil-->
function tec_Enfermedad_marca_05a()
{
	CleanScreen() ;
	
	gotoSlide = 'tec_Enfermedad_marca_05a' ;
	...
	*****************************/
	...
	"<div class='txt02_sld_03_it_Ingr' id='txt02_sld_03_it_Ingr'>"+
		"</br></br>• La niacina, una vitamina B, es el agente más efectivo para </br>"+
		"&nbsp;&nbsp;&nbsp;incrementar la concentración de HDL.</br></br>"+
		
		"• La eficacia del ácido fíbrico (p.ej., clofibrate) es muy variable</br>"+
		"&nbsp;&nbsp;&nbsp;en los pacientes.</br></br>"+
		"• Ezetimibe (p.ej., Zetia®) reduce las concentraciones de </br>"+
		"&nbsp;&nbsp;&nbsp;colesterol total y LDL, al inhibir la absorción de colesterol</br>"+
		"&nbsp;&nbsp;&nbsp;en el intestino delgado. A menudo se indica este</br>"+
		"&nbsp;&nbsp;&nbsp;fármaco junto con estatinas.</br></br>"+
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/metamucil/infoTecnica/enfermedades/au_infoTecnica_enfermedades10_mx.mp3' ;
