<!--Menu Metamucil-->
function tec_Enfermedad_marca_08()
{
	CleanScreen() ;
	
	gotoSlide = 'tec_Enfermedad_marca_08' ;
	...
	*****************************/
	...
	"<div class='txt02_sld_03_it_Ingr' id='txt02_sld_03_it_Ingr'>"+
		...
		"• La insulina es el tratamiento primario de la diabetes tipo 1, mediante el uso de múltiples inyecciones diarias o una bomba de insulina.</br></br>"+
		
		"• Para la diabetes tipo 2 existen varias clases de medicamentos, cada uno con una acción diferente para reducir la glucosa sanguínea. Incluyen:</br></br>"+
				
		"&nbsp;&nbsp;&nbsp;&nbsp;- Metforminas (p.ej., Glucophage®) disminuye la producción de glucosa en el hígado e incrementa </br>"+
		"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;la sensibilidad a la insulina, lo cual reduce la concentración de glucosa sanguínea.</br></br>"+
		
		"&nbsp;&nbsp;&nbsp;&nbsp;- Sulfonilureas estimulan la liberación de insulina del páncreas en los pacientes tipo 2.</br></br>"+
		
		"&nbsp;&nbsp;&nbsp;&nbsp;- Agonistas  de receptor de GLP-1 (p.ej., Victoza®) incrementa </br>"+
		"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;la síntesis y la secreción de insulina."+

	"</div>"+
			//Slide Number
		"<div class='slideNumber'>051</div>"+	
	"" ;
	
	/////////////////////////////////Brasil
	var metam_info_tec_ingredientes_brasil =
	//Selecciona País
	"<div class='txt_Title_bullets' id='txt_Title_bullets'><b>Glicemia </b>medicação de prescrição</div>"+
	...
	"<div class='txt02_sld_03_it_Ingr' id='txt02_sld_03_it_Ingr'>"+
		...
		"</br></br>• A insulina é o tratamento primário do diabetes tipo 1, mediante o uso de múltiplas injeções</br>"+
		  "diárias ou uma bomba de insulina.</br></br>"+
		
		"• Para o diabetes tipo 2 existem várias classes de medicamentos, cada um com uma ação</br>"+
		   "diferente para reduzir a glicose sanguínea.</br></br>"+
		
		"• Os pacientes diabéticos tipo 2 cujas concentrações de açúcares sanguíneos não podem</br>"+
		   "ser controladas com uso de  medicamentos serão tratados com insulina como último recurso. "+
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/metamucil/infoTecnica/enfermedades/au_infoTecnica_enfermedades14_mx.mp3' ;
		...
		case 5:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas/metamucil/au_marcas_metamucil_infoTecnica_enfermedad_bra08.mp3' ;
