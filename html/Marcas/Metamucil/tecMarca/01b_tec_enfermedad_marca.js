<!--Menu Metamucil-->
function tec_Enfermedad_marca_01b()
{
	CleanScreen() ;
	
	gotoSlide = 'tec_Enfermedad_marca_01b' ;
	...
	*****************************/
	...
	"<div style='margin-top:-60px;' class='txt02_sld_01_it_Ingr' id='txt02_sld_01_it_Ingr'>"+
		...
		"<b style='color: #FFF; font-size:1.5em;'>Causas de constipación</b></br>"+
			"La constipación idiopática crónica (CIC) se define como el pasaje</br> infrecuente y difícil de las heces en ausencia de una causa identificable.</br></br>"+
			"&nbsp;&nbsp;&nbsp;&nbsp;• La prevalencia de CIC es de entre el 4% y el 20% de la población.</br>"+
			"&nbsp;&nbsp;&nbsp;&nbsp;• CIC es más común en mujeres y ancianos.</br></br>"+
			
			"La constipación en los ancianos puede estar relacionada con </br>enfermedades crónicas, inmovilidad y medicamentos.</br>"+

			
	"</div>"+
	
	//Slide Number
		"<div class='slideNumber'>039</div>"+
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/metamucil/infoTecnica/enfermedades/au_infoTecnica_enfermedades03_mx.mp3' ;
