<!--Menu Metamucil-->
function tec_Enfermedad_marca_04a()
{
	CleanScreen() ;
	
	gotoSlide = 'tec_Enfermedad_marca_04a' ;
	...
	*****************************/
	...
	//Selecciona País
	"<div class='txt_Title_bullets' id='txt_Title_bullets'><b>Colesterol: </b>fuentes de colesterol</div>"+
	...
	"</div>"+
		...
		//img 02
	"<div style='margin-bottom:50px; margin-right:400px;' class='img01_sld_04_it_enfer' id='img01_sld_04_it_enfer'>"+
		"<img src='img/marcas/metamucil/infoTec/enfermedades/slide4/meta_03.png' width='650' />"+
	"</div>"+	
	...
	"<div class='txt02_sld_03_it_Ingr' id='txt02_sld_03_it_Ingr'>"+
		...
		"• El colesterol ingresa a nuestros organismos del alimento que ingerimos, </br>"+
		"&nbsp;&nbsp;&nbsp;incluso carnes y productos lácteos.</br></br>"+
		
		"• El colesterol también es fabricado en el hígado."+

	"</div>"+
		//Slide Number
		"<div class='slideNumber'>045</div>"+
	"" ;
	
	/////////////////////////////////Brasil
	var metam_info_tec_ingredientes_brasil =
	//Selecciona País
	"<div class='txt_Title_bullets' id='txt_Title_bullets'><b>Colesterol: </b>fontes de colesterol</div>"+
	...
	"</div>"+
		...
		//img 02
	"<div style='margin-bottom:50px; margin-right:400px;' class='img01_sld_04_it_enfer' id='img01_sld_04_it_enfer'>"+
		"<img src='img/marcas/metamucil/infoTec/enfermedades/slide4/meta_02.png' width='650' />"+
	"</div>"+	
	...
	"<div class='txt02_sld_03_it_Ingr' id='txt02_sld_03_it_Ingr'>"+
		...
		"• O colesterol ingressa aos nossos organismos do alimento que ingerimos,</br>"+
		"&nbsp;&nbsp;&nbsp;inclusive carnes e produtos lácteos.</br></br>"+
		
		"• O colesterol também é fabricado no fígado"+
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/metamucil/infoTecnica/enfermedades/au_infoTecnica_enfermedades08_mx.mp3' ;
		...
		case 5:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas/metamucil/au_marcas_metamucil_infoTecnica_enfermedad_bra4a.mp3' ;
