<!--Menu Metamucil-->
function tec_Enfermedad_marca_07()
{
	CleanScreen() ;
	
	gotoSlide = 'tec_Enfermedad_marca_07' ;
	...
	*****************************/
	...
	//Selecciona País
	"<div class='txt_Title_bullets' id='txt_Title_bullets'><b>Glucemia</b> causas</div>"+
	//Elements
		//img 01
	...
	"<div class='img01_sld_07_it_enfer' id='img01_sld_07_it_enfer'>"+
		"<img src='img/marcas/metamucil/infoTec/enfermedades/slide7/meta_01.png' />"+
	"</div>"+	
	
		//texto 1
	"<div class='txt01_sld_01_it_Ingr' id='txt01_sld_01_it_Ingr'>"+
		"Diabetes tipo 1: (solo alrededor del 10% de los diabéticos)"+
	"</div>"+
	
		//texto 2
	"<div class='txt02_sld_03_it_Ingr' id='txt02_sld_03_it_Ingr'>"+
		
		"</br></br>• Causado cuando el propio sistema inmune de una persona destruye </br>las células secretoras de insulina en el páncreas.</br></br>"+
		
		"• Los diabéticos tipo 1 no producen insulina; deben inyectarla para sobrevivir. </br></br></br>"+
		
		"<b style='color: #FFF; font-size:1.5em;'>Diabetes tipo 2:</b> </br>"+
		
		"• Causada por resistencia a la insulina y </br>defectos de la secreción de insulina. </br></br>"+
		
		"• La mayoría de los diabéticos tipo 2 son obesos, </br>lo cual causa la resistencia a la insulina."+

	"</div>"+
		//Slide Number
		"<div class='slideNumber'>050</div>"+		
	"" ;
	
	/////////////////////////////////Brasil
	var metam_info_tec_ingredientes_brasil =
	//Selecciona País
	"<div class='txt_Title_bullets' id='txt_Title_bullets'><b>Glicemia </b>causas</div>"+
	...
	"</div>"+	
		...
		//texto 1
	"<div class='txt01_sld_01_it_Ingr' id='txt01_sld_01_it_Ingr'>"+
		"Diabetes tipo 1: (somente ao redor de 10% dos diabéticos)"+
	"</div>"+
	
		//texto 2
	"<div class='txt02_sld_03_it_Ingr' id='txt02_sld_03_it_Ingr'>"+
		
		"</br></br>• Causado quando o próprio sistema imune de uma pessoa destroi as células</br>"+
		   "secretoras de insulina no pâncreas.</br></br>"+
		
		"• Os diabéticos tipo 1 não produzem insulina; devem injetá-la</br>"+
		   "para sobreviver.</br></br></br>"+
		
		"<b style='color: #FFF; font-size:1.5em;'>Diabetes tipo 2:</b> </br>"+
		
		"• Causada por resistência à insulina e defeitos da secreção de insulina.</br></br>"+
		
		"• A maioria dos diabéticos tipo 2 são obesos, o que causa a resistência â insulina."+
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			TweenMax.fromTo(img01_sld_07_it_enfer , 1 , {css:{opacity:"0" , transform:"scale(.1,.1)"}} , {css:{opacity:"1" , transform:"scale(1,1)"}, delay:.8}) ;
			...
			function exit_mx()
			{
				...
				var img01_sld_07_it_enfer = document.getElementById("img01_sld_07_it_enfer") ;
				TweenMax.fromTo(img01_sld_07_it_enfer , 1 , {css:{opacity:"1" , transform:"scale(1,1)"}} , {css:{opacity:"0" , transform:"scale(.1,.1)"}, delay:0}) ;
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/metamucil/infoTecnica/enfermedades/au_infoTecnica_enfermedades13_mx.mp3' ;
		...
		case 5:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas/metamucil/au_marcas_metamucil_infoTecnica_enfermedad_bra07.mp3' ;
