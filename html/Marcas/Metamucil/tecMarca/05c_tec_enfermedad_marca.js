<!--Menu Metamucil-->
function tec_Enfermedad_marca_05c()
{
	CleanScreen() ;
	
	gotoSlide = 'tec_Enfermedad_marca_05c' ;
	...
	*****************************/
	...
	//Selecciona País
	"<div class='txt_Title_bullets' id='txt_Title_bullets'><b>Colesterol: </b>metamucil para reducir el colesterol </div>"+
	...
	"<div class='txt02_sld_03_it_Ingr' id='txt02_sld_03_it_Ingr'>"+
		...
		"</br></br></br></br>• Los ácidos biliares y el colesterol en el intestino </br>"+
		"&nbsp;&nbsp;&nbsp;delgado son atrapados y ligados al espeso gel de</br>"+
		"&nbsp;&nbsp;&nbsp;Metamucil y parte de ellos es eliminado</br>"+
		"&nbsp;&nbsp;&nbsp;con los residuos.</br></br>"+
		
		"• El hígado usa el colesterol de la sangre para fabricar </br>"+
		"&nbsp;&nbsp;&nbsp;más ácidos biliares para la digestión es eliminado</br>"+
		"&nbsp;&nbsp;&nbsp;con los residuos.</br></br>"+
		
		"• Menos colesterol en la sangre."+
	...
	//Selecciona País
	"<div class='txt_Title_bullets' id='txt_Title_bullets'><b>Colesterol: </b>como metamucil age</div>"+
	...
	"</div>"+
		...
		//img 02
	"<div style='margin-bottom:150px; margin-right:0px;' class='img01_sld_02_it_enfer' id='img01_sld_02_it_enfer'>"+
		"<img src='img/marcas/metamucil/infoTec/enfermedades/slide2/meta_02.png'/>"+
	"</div>"+	
	
		//texto 2
	"<div class='txt02_sld_03_it_Ingr' id='txt02_sld_03_it_Ingr'>"+
		
		"</br></br></br></br>• Os ácidos biliares e o colesterol no intestino delgado</br>"+
		"&nbsp;&nbsp;&nbsp;sãocapturados e ligados ao espesso gel de Metamucil</br>"+
		"&nbsp;&nbsp;&nbsp;e parte deles é eliminado com os resíduos.</br></br>"+
		
		"• O fígado usa o colesterol do sangue para </br>"+
		"&nbsp;&nbsp;&nbsp;fabricar mais ácidos biliares para a digestão.</br></br>"+
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/metamucil/infoTecnica/enfermedades/au_infoTecnica_enfermedades11_mx.mp3' ;
		...
		case 5:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas/metamucil/au_marcas_metamucil_infoTecnica_enfermedad_bra05c.mp3' ;
