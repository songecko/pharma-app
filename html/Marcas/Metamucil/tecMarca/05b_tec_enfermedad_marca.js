<!--Menu Metamucil-->
function tec_Enfermedad_marca_05b()
{
	CleanScreen() ;
	
	gotoSlide = 'tec_Enfermedad_marca_05b' ;
	...
	*****************************/
	...
	"<div class='txt02_sld_03_it_Ingr' id='txt02_sld_03_it_Ingr'>"+
		...
		"</br></br></br></br></br></br>• La eficacia del ácido fíbrico (p.ej., clofibrate) es muy variable en los pacientes.</br></br>"+
						
		"• Ezetimibe (p.ej., Zetia®) reduce las concentraciones de colesterol total </br>"+
		"&nbsp;&nbsp;&nbsp;y LDL, al inhibir la absorción de colesterol en el intestino delgado.</br>"+
		"&nbsp;&nbsp;&nbsp;A menudo se indica este fármaco junto con estatinas.</br></br>"+
