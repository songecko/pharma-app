<!--Menu Metamucil-->
function tec_Ingredientes_marca_01()
{
	CleanScreen() ;
	
	gotoSlide = 'tec_Ingredientes_marca_01' ;
	...
	*****************************/
	...
	var metam_info_tec_ingredientes_mexico =
		//Selecciona País
		"<div class='txt_Title_bullets' id='txt_Title_bullets'>¿Qué es la <b>fibra dietética?</b></div>"+
		...
		"</div>"+
			...
			//img 02
		"<div style='margin-bottom:200px; margin-right:30px;' class='img02_sld_01_it_Ingr' id='img02_sld_01_it_Ingr'>"+
		...
		"<div class='txt01_sld_01_it_Ingr' id='txt01_sld_01_it_Ingr'>"+
			"Los hidratos de carbono y polímeros que no son digeribles de las plantas y tienen efectos fisiológicos."+
		"</div>"+
		...
		"<div class='txt02_sld_01_it_Ingr' id='txt02_sld_01_it_Ingr'>"+
			...
			"Tipos</br></br>"+
			"• Soluble:</br>"+
			"- La fibra soluble forma un material similar</br>"+
			"&nbsp;&nbsp;al gel en contacto con el agua</br>"+		
			"- Buenas fuentes: avena, frijoles, guisantes,</br>"+
			"&nbsp;&nbsp;muchos tipos de fruta</br></br>"+
			"• Insoluble</br>"+		
			"- Se mueve a través del sistema digestivo de forma </br>"+
			"&nbsp;&nbsp;rápida y en gran parte intacto</br>"+
			"- Buenas fuentes son: el trigo, los cereales y los panes y</br>"+
			"&nbsp;&nbsp;muchas verduras</br>"+
	
		"</div>"+
		
		//Slide Number
		"<div class='slideNumber'>033</div>"+
	...
	var metam_info_tec_ingredientes_brasil =
		//Selecciona País
		"<div class='txt_Title_bullets' id='txt_Title_bullets'>O que é a fibra <b>da dieta</b></div>"+
		...
		"</div>"+
			...
			//img 02
		"<div style='margin-bottom:200px; margin-right:30px;' class='img02_sld_01_it_Ingr' id='img02_sld_01_it_Ingr'>"+
			"<img src='img/marcas/metamucil/infoTec/ingredientes/slide1/meta_02_bra.png' />"+
		"</div>"+	
		...
		"<div class='txt02_sld_01_it_Ingr' id='txt02_sld_01_it_Ingr'>"+
			...
			"Tipos</br></br>"+
			"• Solúvel:</br>"+
			"- A fibra solúvel forma um material tipo gel em </br>"+
			"&nbsp;&nbsp;contato com a água</br>"+		
			"- São boas fontes: aveia, feijão, ervilha,</br>"+
			"&nbsp;&nbsp;muitos tipos de frutas</br></br>"+
			"• Insolúvel</br>"+		
			"- é movimentada pelo sistema digestivo rapidamente e,</br>"+
			"&nbsp;&nbsp;em grande parte, intacta</br>"+
			"- As boas fontes são: trigo, cereais e pães integrais e</br>"+
			"&nbsp;&nbsp;muitos vegetais</br>"+
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			var img02_sld_01_it_Ingr = document.getElementById("img02_sld_01_it_Ingr") ;
			TweenMax.fromTo(img02_sld_01_it_Ingr , 1 , {css:{opacity:"0" , transform:"scale(.1,.1)"}} , {css:{opacity:"1" , transform:"scale(1,1)"}, delay:.8}) ;
			...
			function exit_mx()
			{
				...
				var img02_sld_01_it_Ingr = document.getElementById("img02_sld_01_it_Ingr") ;
				TweenMax.fromTo(img02_sld_01_it_Ingr , 1 , {css:{opacity:"1" , transform:"scale(1,1)"}} , {css:{opacity:"0" , transform:"scale(.1,.1)"}, delay:0}) ;
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas_mx/metamucil/infoTecnica/ingredientesActivos/au_infoTecnica_IngredActivos01_mx.mp3' ;
		...
		case 5:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/marcas/metamucil/au_marcas_metamucil_infoTecnica_ingredientes_bra01.mp3' ;
