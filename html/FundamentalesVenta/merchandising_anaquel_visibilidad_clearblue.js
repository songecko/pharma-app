<!--Video Intro-->
function merchandising_anaquel_visibilidad_clearblue()
{
	CleanScreen() ;
	gotoSlide = 'merchandising_anaquel_visibilidad_clearblue' ;
	...
	*****************************/
	/////////////////////////////////Mexico
	var merchandising_anaquel_visibilidad_clearblue_mexico =	
		//Selecciona País
		...
		"<div class='imageVisibilidade' id='imageVisibilidade_vicks_02'><img src='img/Fundamentales/Merchandising/img_visibilidade_clearblue_02.png' /></div>"+
			//03
		"<div class='imageVisibilidade' id='imageVisibilidade_vicks_03'><img src='img/Fundamentales/Merchandising/img_visibilidade_clerablue_03.png' /></div>"+
	...
	/////////////////////////////////Brasil
	var merchandising_anaquel_visibilidad_clearblue_brasil =	
	...
	***********************************************/
	...
	switch( languageCountry )
	{
		//México
		case 1:
			document.getElementById("Container").innerHTML = generalElements + merchandising_anaquel_visibilidad_clearblue_mexico ;
			...
			***********************************************/
			...
			/////////////////////////////////Exit Animation
			function exit_merchandising_anaquel_visibilidad_clearblue_mex()
			{
				var txt_Title_bullets = document.getElementById("txt_Title_bullets") ;
			...
			***********************************************/
			...
			$('#ico_01').click(function() {
				pagChange = -2 ;
				exit_merchandising_anaquel_visibilidad_clearblue_mex() ;
			});
			...
			$('#worlMap_icon').click(function() {
				pagChange = -1 ;
				//merchandising_anaquel_visibilidad_clearblue.src = '' ;
				exit_merchandising_anaquel_visibilidad_clearblue_mex() ;
			}) ;
		...
		//Brasil
		case 5:
			document.getElementById("Container").innerHTML = generalElements + merchandising_anaquel_visibilidad_clearblue_brasil ;
			...
			***********************************************/
			...
			/////////////////////////////////Exit Animation
			function exit_merchandising_anaquel_visibilidad_clearblue()
			{
				var noDisponible = document.getElementById("noDisponible") ;
			...
			***********************************************/
			...
			$('#ico_01').click(function() {
				pagChange = -2 ;
				exit_merchandising_anaquel_visibilidad_clearblue() ;
			});
