<!--Video Intro-->
function merchandising_anaquel_visibilidad_peptoBismol()
{
	CleanScreen() ;
	gotoSlide = 'merchandising_anaquel_visibilidad_peptoBismol' ;
	...
	*****************************/
	/////////////////////////////////Mexico
	var merchandising_anaquel_visibilidad_peptoBismol_mexico =	
		//Selecciona País
		"<div class='txt_Title_bullets' id='txt_Title_bullets'>Pepto-Bismol / <b>Visibilidad</b></div>"+
		
		//Images
			//01
		"<div class='imageVisibilidade' id='imageVisibilidade_vicks_01'><img src='img/Fundamentales/Merchandising/img_visibilidade_peptoBismol_01.png' /></div>"+
			//02
		"<div class='imageVisibilidade' id='imageVisibilidade_vicks_02'><img src='img/Fundamentales/Merchandising/img_visibilidade_peptoBismol_02.png' /></div>"+
			//03
		"<div class='imageVisibilidade' id='imageVisibilidade_vicks_03'><img src='img/Fundamentales/Merchandising/img_visibilidade_peptoBismol_03.png' /></div>"+
	...
	/////////////////////////////////Brasil
	var merchandising_anaquel_visibilidad_peptoBismol_brasil =	
	...
	***********************************************/
	...
	switch( languageCountry )
	{
		//México
		case 1:
			document.getElementById("Container").innerHTML = generalElements + merchandising_anaquel_visibilidad_peptoBismol_mexico ;
			...
			***********************************************/
			...
			/////////////////////////////////Exit Animation
			function exit_merchandising_anaquel_visibilidad_peptoBismol_mex()
			{
				var txt_Title_bullets = document.getElementById("txt_Title_bullets") ;
			...
			***********************************************/
			...
			$('#ico_01').click(function() {
				pagChange = -2 ;
				exit_merchandising_anaquel_visibilidad_peptoBismol_mex() ;
			});
			...
			$('#worlMap_icon').click(function() {
				pagChange = -1 ;
				//merchandising_anaquel_visibilidad_peptoBismol.src = '' ;
				exit_merchandising_anaquel_visibilidad_peptoBismol_mex() ;
			}) ;
		...
		//Brasil
		case 5:
			document.getElementById("Container").innerHTML = generalElements + merchandising_anaquel_visibilidad_peptoBismol_brasil ;
			...
			***********************************************/
			...
			/////////////////////////////////Exit Animation
			function exit_merchandising_anaquel_visibilidad_peptoBismol()
			{
				var noDisponible = document.getElementById("noDisponible") ;
			...
			***********************************************/
			...
			$('#ico_01').click(function() {
				pagChange = -2 ;
				exit_merchandising_anaquel_visibilidad_peptoBismol() ;
			});
