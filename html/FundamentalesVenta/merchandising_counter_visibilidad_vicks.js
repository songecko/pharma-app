<!--Video Intro-->
function merchandising_counter_visibilidad_vicks()
{
	CleanScreen() ;
	gotoSlide = 'merchandising_counter_visibilidad_vicks' ;
	...
	*****************************/
	/////////////////////////////////México
	var merchandising_counter_visibilidad_vicks_mexico =	
		//Selecciona País
	...
	/////////////////////////////////Brasil
	var merchandising_counter_visibilidad_vicks_brasil =	
		//Selecciona País
	...
	***********************************************/
	...
	switch( languageCountry )
	{
		//México
		case 1:
			document.getElementById("Container").innerHTML = generalElements + merchandising_counter_visibilidad_vicks_mexico ;
			...
			***********************************************/
			...
			/////////////////////////////////Exit Animation
			function exit_merchandising_counter_visibilidad_vicks_mex()
			{
				var txt_Title_bullets = document.getElementById("txt_Title_bullets") ;
			...
			***********************************************/
			...
			$('#ico_01').click(function() {
				pagChange = -2 ;
				exit_merchandising_counter_visibilidad_vicks_mex() ;
			});
			...
			***********************************************/
			...
			auLocucion.src = 'audio/FundamentalesVenta/au_fundamentales_vicks_visibilidad_counter_mx.mp3' ;
		...
		//Brasil
		case 5:
			document.getElementById("Container").innerHTML = generalElements + merchandising_counter_visibilidad_vicks_brasil ;
			...
			***********************************************/
			...
			/////////////////////////////////Exit Animation
			function exit_merchandising_counter_visibilidad_vicks()
			{
				var txt_Title_bullets = document.getElementById("txt_Title_bullets") ;
			...
			***********************************************/
			...
			$('#ico_01').click(function() {
				pagChange = -2 ;
				exit_merchandising_counter_visibilidad_vicks() ;
			});
			...
			$('#worlMap_icon').click(function() {
				pagChange = -1 ;
				//merchandising_counter_visibilidad_vicks.src = '' ;
				exit_merchandising_counter_visibilidad_vicks() ;
			}) ;
			...
			***********************************************/
			...
			auLocucion.src = 'audio/FundamentalesVenta/au_fundamentales_vicks_visibilidad_counter_bra.mp3' ;
