<!--Video Intro-->
function merchandising_counter_visibilidad_peptoBismol()
{
	CleanScreen() ;
	gotoSlide = 'merchandising_counter_visibilidad_peptoBismol' ;
	...
	*****************************/
	/////////////////////////////////México
	var merchandising_counter_visibilidad_peptoBismol_mexico =	
		//Selecciona País
	...
	/////////////////////////////////Brasil
	var merchandising_counter_visibilidad_peptoBismol_brasil =	
	...
	***********************************************/
	...
	switch( languageCountry )
	{
		//México
		case 1:
			document.getElementById("Container").innerHTML = generalElements + merchandising_counter_visibilidad_peptoBismol_mexico ;
			...
			***********************************************/
			...
			/////////////////////////////////Exit Animation
			function exit_merchandising_counter_visibilidad_peptoBismol_mex()
			{
				var txt_Title_bullets = document.getElementById("txt_Title_bullets") ;
			...
			***********************************************/
			...
			$('#ico_01').click(function() {
				pagChange = -2 ;
				exit_merchandising_counter_visibilidad_peptoBismol_mex() ;
			});
		...
		//Brasil
		case 5:
			document.getElementById("Container").innerHTML = generalElements + merchandising_counter_visibilidad_peptoBismol_brasil ;
			...
			***********************************************/
			...
			/////////////////////////////////Exit Animation
			function exit_merchandising_counter_visibilidad_peptoBismol()
			{
				var noDisponible = document.getElementById("noDisponible") ;
			...
			***********************************************/
			...
			$('#ico_01').click(function() {
				pagChange = -2 ;
				exit_merchandising_counter_visibilidad_peptoBismol() ;
			});
			...
			$('#worlMap_icon').click(function() {
				pagChange = -1 ;
				//merchandising_counter_visibilidad_peptoBismol.src = '' ;
				exit_merchandising_counter_visibilidad_peptoBismol() ;
			}) ;
