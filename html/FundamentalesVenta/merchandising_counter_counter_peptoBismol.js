<!--Anaquel-->
function merchandising_counter_counter_peptoBismol()
{
	CleanScreen() ;
	
	gotoSlide = 'merchandising_counter_counter_peptoBismol' ;
	...
	*****************************/
	/////////////////////////////////México
	var merchandising_counter_counter_peptoBismol_mexico =
		//Selecciona País
		"<div class='txt_Title_bullets' id='txt_Title_bullets'>Mostrador <b>Pepto-Bismol</b></div>"+

		//Images
		"<div class='materialVisibilidad_img' id='merchandising_counter_peptoBismol_back'>"+
			//Changing Image
		...
		//Over images
			//Clearblue
		"<div class='img_overAnaquel' id='overAnaquel_peptoBismol_01'><img src='img/Fundamentales/Merchandising/img_counter_peptoBismol_02.png'></div>"+
		"<div class='img_overAnaquel' id='overAnaquel_peptoBismol_02'><img src='img/Fundamentales/Merchandising/img_counter_peptoBismol_03.png'></div>"+
		"<div class='img_overAnaquel' id='overAnaquel_peptoBismol_03'><img src='img/Fundamentales/Merchandising/img_counter_peptoBismol_04.png'></div>"+
	...
	/////////////////////////////////Brasil
	var merchandising_counter_counter_peptoBismol_brasil =
		//No content
	...
	***********************************************/
	...
	switch( languageCountry )
	{
		//México
		case 1:
			document.getElementById("Container").innerHTML = generalElements + merchandising_counter_counter_peptoBismol_mexico ;
			...
			***********************************************/
			...
			var merchandising_counter_peptoBismol_back = document.getElementById("merchandising_counter_peptoBismol_back") ;
			...
			TweenMax.staggerFromTo ([merchandising_counter_peptoBismol_back , merch_btn_01 , merch_btn_02 , merch_btn_03] , 1 , {css:{opacity:"0" , transform:"scale(1.5,1.5)"}} , {css:{opacity:"1" , transform:"scale(1,1)"}} , .25) ;
			
			/////////////////////////////////Exit animation
			function exit_merchandising_counter_counter_peptoBismol_mex()
			{
				var txt_Title_bullets = document.getElementById("txt_Title_bullets") ;
				...
				TweenMax.staggerFromTo ([merchandising_counter_peptoBismol_back , merch_btn_01 , merch_btn_02 , merch_btn_03] , 1 , {css:{opacity:"1" , transform:"scale(1,1)"}} , {css:{opacity:"0" , transform:"scale(1.5,1.5)"}} , .25) ;
			...
			***********************************************/
			...
			auLocucion.src = 'audio/FundamentalesVenta/au_Fundamentales_counter_portafolioPepto_mx.mp3' ;
			...
			***********************************************/
			...
			auLocucion.src = 'audio/FundamentalesVenta/au_Fundamentales_counter_localizacionPepto_mx.mp3' ;
			...
			***********************************************/
			...
			auLocucion.src = 'audio/FundamentalesVenta/au_Fundamentales_counter_bloquePepto_mx.mp3' ;
			...
			***********************************************/
			...
			$('#ico_01').click(function() {
				pagChange = -2 ;
				exit_merchandising_counter_counter_peptoBismol_mex() ;
			});
			...
			***********************************************/
			...
			auLocucion.src = 'audio/FundamentalesVenta/au_merchandising_counter_counter_peptoBismol_mex_01.mp3' ;
		...
		//Brasil
		case 5:
			document.getElementById("Container").innerHTML = generalElements + merchandising_counter_counter_peptoBismol_brasil ;
			...
			***********************************************/
			...
			/////////////////////////////////Exit animation
			function exit_merchandising_counter_counter_peptoBismol()
			{
				var noDisponible = document.getElementById("noDisponible") ;
				...
				function ChangePage()
				{
					...
					{						
						...
						case 0:
							merchandising_counter_counter_peptoBismol_menu() ;
						break;
			...
			***********************************************/
			...
			$('#ico_01').click(function() {
				pagChange = -2 ;
				exit_merchandising_counter_counter_peptoBismol() ;
			});
			...
			***********************************************/
			...
			auLocucion.src = 'audio/FundamentalesVenta/au_merchandising_counter_counter_peptoBismol_bra_01.mp3' ;
