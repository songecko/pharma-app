...
function counter()
{
	...
	*****************************/
	...
	var counter_mexico =
		//Selecciona País
		"<div class='txt_Title_bullets' id='txt_Title_bullets'><b>Mostrador</b></div>"+

		//Images
		"<div class='materialVisibilidad_img' id='counter_back'>"+
			//Changing Image
			"<div class='BackImage_Anaquel'><img src='img/Fundamentales/Anaquel/img_counter_mex.jpg' id='BackImage_Anaquel_01'></div>"+
		...
		//Over images
			//Vick
		"<div class='img_overAnaquel' id='overAnaquel_vicks_01'><img src='img/Fundamentales/Anaquel/img_counter_vick_01.jpg'></div>"+
		"<div class='img_overAnaquel' id='overAnaquel_vicks_02'><img src='img/Fundamentales/Anaquel/img_counter_vick_02.jpg'></div>"+
		
			//Metamucil
		"<div class='img_overAnaquel' id='overAnaquel_metamucil_01'><img src='img/Fundamentales/Anaquel/img_counter_metamucil_01.jpg'></div>"+
		"<div class='img_overAnaquel' id='overAnaquel_metamucil_02'><img src='img/Fundamentales/Anaquel/img_counter_metamucil_02.jpg'></div>"+
		
			//PeptoBismol
		"<div class='img_overAnaquel' id='overAnaquel_peptoBismol_01'><img src='img/Fundamentales/Anaquel/img_counter_peptoBismol_01.jpg'></div>"+
		"<div class='img_overAnaquel' id='overAnaquel_peptoBismol_02'><img src='img/Fundamentales/Anaquel/img_counter_peptoBismol_02.jpg'></div>"+
		
			//Clearblue
		"<div class='img_overAnaquel' id='overAnaquel_clearblue_01'><img src='img/Fundamentales/Anaquel/img_counter_clearblue_01.jpg'></div>"+
		"<div class='img_overAnaquel' id='overAnaquel_clearblue_02'><img src='img/Fundamentales/Anaquel/img_counter_clearblue_02.jpg'></div>"+
	...
	var counter_brasil =
		//Selecciona País
		"<div class='txt_Title_bullets' id='txt_Title_bullets'><b>Balcão</b></div>"+

		//Images
		"<div class='materialVisibilidad_img' id='counter_back'>"+
			//Changing Image
			"<div class='BackImage_Anaquel'><img src='img/Fundamentales/Anaquel/img_counter_vick_01.png' id='BackImage_Anaquel_01'></div>"+
			
			//Background
			"<img src='img/Fundamentales/Anaquel/img_backAnaquel.jpg'/>"+
	...
	***********************************************/
	...
	switch( languageCountry )
	{
		//México
		case 1:
			document.getElementById("Container").innerHTML = generalElements + counter_mexico ;
			...
			***********************************************/
			...
			var counter_back = document.getElementById("counter_back") ;
			...
			TweenMax.fromTo (counter_back , .5 , {css:{opacity:"0" , transform:"scale(1.5,1.5)"}} , {css:{opacity:"1" , transform:"scale(1,1)"}}) ;
			...
			/////////////////////////////////Exit animation
			function exit_counter_mex()
			{
				var txt_Title_bullets = document.getElementById("txt_Title_bullets") ;
			
				var counter_back = document.getElementById("counter_back") ;
				
				TweenMax.killTweensOf([txt_Title_bullets , counter_back]) ;
				...
				TweenMax.fromTo (counter_back , .5 , {css:{opacity:"1" , transform:"scale(1,1)"}} , {css:{opacity:"0" , transform:"scale(1.5,1.5)"}}) ;
			...
			***********************************************/
			...
			auLocucion.src = 'audio/FundamentalesVenta/au_counter_mex_01.mp3' ;
		...
		//Brasil
		case 5:
			document.getElementById("Container").innerHTML = generalElements + counter_brasil ;
			...
			***********************************************/
			...
			auLocucion.src = 'audio/FundamentalesVenta/au_counter_bra_01.mp3' ;
