...
function merchandising_counter_menu()
{
	CleanScreen() ;
	
	gotoSlide = 'merchandising_counter_menu' ;
	...
	*****************************/
	/////////////////////////////////México
	var merchandising_counter_menu_mexico =
		//Selecciona País
		"<div class='txt_Title_bullets' id='txt_Title_bullets'>Selecione el fundamental de ventas que <b>desee consultar</b></div>"+

		//Back Image
		"<div class='materialVisibilidad_img' id='merchandising_anaquel_menu_back'><img src='img/Fundamentales/Merchandising/img_back_checkOut_mex.png'/></div>"+
		...
		"<div class='btn_circle' id='btn_circle_anaquel_peptoBismol_mex' onmouseover='rollOver_btn_circle_anaquel_peptoBismol_mex()'><img src='img/Fundamentales/Merchandising/btn_circle_peptoBismol.png'/></div>"+
				//Gondola
		"<div class='btn_rectangle_fundamentales' id='rectangle_gondola_pepto_mex'>Mostrador</div>"+
				//Visibilidade
		...
		"<div class='btn_circle' id='btn_circle_anaquel_metamucil_mex' onmouseover='rollOver_btn_circle_anaquel_metamucil_mex()'><img src='img/Fundamentales/Merchandising/btn_circle_metamucil.png'/></div>"+
				//Gondola
		"<div class='btn_rectangle_fundamentales' id='rectangle_gondola_metamucil_mex'>Mostrador</div>"+
				//Visibilidade
		...
		"<div class='btn_circle' id='btn_circle_anaquel_vicks_mex' onmouseover='rollOver_btn_circle_anaquel_vicks_mex()'><img src='img/Fundamentales/Merchandising/btn_circle_vicks.png'/></div>"+
				//Gondola
		"<div class='btn_rectangle_fundamentales' id='rectangle_gondola_vicks_mex'>Mostrador</div>"+
				//Visibilidade
		...
		"<div class='btn_circle' id='btn_circle_anaquel_clearblue_mex' onmouseover='rollOver_btn_circle_anaquel_clearblue_mex()'><img src='img/Fundamentales/Merchandising/btn_circle_clearblue.png'/></div>"+
				//Gondola
		"<div class='btn_rectangle_fundamentales' id='rectangle_gondola_clearblue_mex'>Mostrador</div>"+
				//Visibilidade
	...
	/////////////////////////////////Brasil
	var merchandising_counter_menu_brasil =
		//Selecciona País
		"<div class='txt_Title_bullets' id='txt_Title_bullets'>Selecione o fudamento de vendas que <b>deseja consultar</b></div>"+

		//Back Image
		"<div class='materialVisibilidad_img' id='merchandising_counter_menu_back'><img src='img/Fundamentales/Merchandising/img_back_checkOut.png'/></div>"+
		...
		"<div class='btn_circle' id='btn_circle_anaquel_metamucil' onmouseover='rollOver_btn_circle_anaquel_metamucil()'><img src='img/Fundamentales/Merchandising/btn_circle_metamucil.png'/></div>"+
				//Balcão
		"<div class='btn_rectangle_fundamentales' id='rectangle_gondola_metamucil'>Balcão</div>"+
				//Visibilidade
		...
		"<div class='btn_circle' id='btn_circle_anaquel_hipoglos' onmouseover='rollOver_btn_circle_anaquel_hipoglos()'><img src='img/Fundamentales/Merchandising/btn_circle_hipoglos.png'/></div>"+
				//Balcão
		"<div class='btn_rectangle_fundamentales' id='rectangle_gondola_hipoglos'>Balcão</div>"+
				//Visibilidade
		...
		"<div class='btn_circle' id='btn_circle_anaquel_vicks' onmouseover='rollOver_btn_circle_anaquel_vicks()''><img src='img/Fundamentales/Merchandising/btn_circle_vicks.png'/></div>"+
				//Balcão
		"<div class='btn_rectangle_fundamentales' id='rectangle_gondola_vicks'>Balcão</div>"+
				//Visibilidade
	...
	***********************************************/
	...
	switch( languageCountry )
	{
		//México
		case 1:
			document.getElementById("Container").innerHTML = generalElements + merchandising_counter_menu_mexico ;
			...
			***********************************************/
			...
			/////////////////////////////////Exit animation
			function exit_merchandising_counter_menu_mex()
			{
				var txt_Title_bullets = document.getElementById("txt_Title_bullets") ;
				...
				function ChangePage()
				{
					...
					{						
						...
						case 1:
							merchandising_counter_counter_peptoBismol() ;
						break;
						
						case 2:
							merchandising_counter_visibilidad_peptoBismol() ;
						break;
						
						case 3:
							merchandising_counter_counter_metamucil() ;
						break;
						
						case 4:
							merchandising_counter_visibilidad_metamucil() ;
						break;
						
						case 5:
							merchandising_counter_counter_vicks() ;
						break;
						
						case 6:
							merchandising_counter_visibilidad_vicks() ;
						break;
						
						case 7:
							merchandising_counter_counter_clearblue() ;
						break;
						
						case 8:
							merchandising_counter_visibilidad_clearblue() ;
						break;
					}
				}
			}
			...
			function showHide_metamucil_mex()
			{
				...
				if((metamucilButtons%2) != 0)
				{
					TweenMax.fromTo([rectangle_gondola_metamucil_mex , rectangle_visibilidad_metamucil_mex] , .5 , {css:{opacity:"0"}} , {css:{opacity:"1"}}) ;
				}else
				{
					TweenMax.fromTo([rectangle_gondola_metamucil_mex , rectangle_visibilidad_metamucil_mex] , .5 , {css:{opacity:"1"}} , {css:{opacity:"0"}}) ;
				}
			}
			...
			***********************************************/
			...
			$('#ico_01').click(function() {
				pagChange = -2 ;
				exit_merchandising_counter_menu_mex() ;
			});
			...
			***********************************************/
			...
			auLocucion.src = 'audio/FundamentalesVenta/au_counterMenu_mex.mp3' ;
		...
		//Brasil
		case 5:
			document.getElementById("Container").innerHTML = generalElements + merchandising_counter_menu_brasil ;
			...
			***********************************************/
			...
			var merchandising_counter_menu_back = document.getElementById("merchandising_counter_menu_back") ;
			...
			TweenMax.fromTo (txt_Title_bullets , 1 , {css:{opacity:"0"}} , {css:{opacity:"1"}}) ;
			TweenMax.fromTo (merchandising_counter_menu_back , .5 , {css:{opacity:"0" , transform:"scale(1.5,1.5)"}} , {css:{opacity:"1" , transform:"scale(1,1)"}}) ;
			...
			/////////////////////////////////Exit animation
			function exit_merchandising_counter_menu()
			{
				var txt_Title_bullets = document.getElementById("txt_Title_bullets") ;
				...
				TweenMax.killTweensOf([txt_Title_bullets , merchandising_counter_menu_back , btn_circle_anaquel_metamucil , btn_circle_anaquel_hipoglos , btn_circle_anaquel_vicks]) ;
				
				TweenMax.fromTo (txt_Title_bullets , 1 , {css:{opacity:"1"}} , {css:{opacity:"0"} , onComplete:ChangePage}) ;
				
				TweenMax.fromTo (merchandising_counter_menu_back , .5 , {css:{opacity:"1" , transform:"scale(1,1)"}} , {css:{opacity:"0" , transform:"scale(1.5,1.5)"}}) ;
				...
				function ChangePage()
				{
					...
					{						
						...
						case 3:
							merchandising_counter_counter_hipoglos() ;
						break;
						
						case 4:
							merchandising_counter_visibilidad_hipoglos() ;
						break;
			...
			***********************************************/
			...
			$('#ico_01').click(function() {
				pagChange = -2 ;
				exit_merchandising_counter_menu() ;
			});
			...
			***********************************************/
			...
			auLocucion.src = 'audio/FundamentalesVenta/au_counterMenu_bra.mp3' ;
