<!--Video Intro-->
function merchandising_counter_visibilidad_hipoglos()
{
	CleanScreen() ;
	gotoSlide = 'merchandising_counter_visibilidad_hipoglos' ;
	...
	*****************************/
	/////////////////////////////////México
	var merchandising_counter_visibilidad_hipoglos_mexico =	
	...
	/////////////////////////////////Video
	var merchandising_counter_visibilidad_hipoglos_brasil =	
		//Selecciona País
	...
	***********************************************/
	...
	switch( languageCountry )
	{
		//México
		case 1:
			document.getElementById("Container").innerHTML = generalElements + merchandising_counter_visibilidad_hipoglos_mexico ;
			...
			***********************************************/
			...
			/////////////////////////////////Exit Animation
			function exit_merchandising_counter_visibilidad_hipoglos_mex()
			{
				var noDisponible = document.getElementById("noDisponible") ;
			...
			***********************************************/
			...
			$('#ico_01').click(function() {
				pagChange = -2 ;
				exit_merchandising_counter_visibilidad_hipoglos_mex() ;
			});
			...
			***********************************************/
			...
			auLocucion.src = 'audio/FundamentalesVenta/au_fundamentales_hipoglos_visibilidad_counter_mex.mp3' ;
		...
		//Brasil
		case 5:
			document.getElementById("Container").innerHTML = generalElements + merchandising_counter_visibilidad_hipoglos_brasil ;
			...
			***********************************************/
			...
			TweenMax.staggerFromTo ([imageVisibilidade_hipoglos_01 , imageVisibilidade_hipoglos_02] , .5 , {css:{opacity:"0" , transform:"scale(1.5,1.5)"}} , {css:{opacity:"1" , transform:"scale(1,1)"} , delay: .5}, .25) ;
			
			/////////////////////////////////Exit Animation
			function exit_merchandising_counter_visibilidad_hipoglos()
			{
				var txt_Title_bullets = document.getElementById("txt_Title_bullets") ;
				...
				TweenMax.killTweensOf([txt_Title_bullets , imageVisibilidade_hipoglos_01 , imageVisibilidade_hipoglos_02]) ;
				
				TweenMax.fromTo (txt_Title_bullets , 1 , {css:{opacity:"1"}} , {css:{opacity:"0"} , onComplete:ChangePage}) ;
				
				TweenMax.staggerFromTo ([imageVisibilidade_hipoglos_01 , imageVisibilidade_hipoglos_02] , .5 , {css:{opacity:"1" , transform:"scale(1,1)"}} , {css:{opacity:"0" , transform:"scale(1.5,1.5)"}}, .25) ;
			...
			***********************************************/
			...
			$('#ico_01').click(function() {
				pagChange = -2 ;
				exit_merchandising_counter_visibilidad_hipoglos() ;
			});
			...
			$('#worlMap_icon').click(function() {
				pagChange = -1 ;
				//merchandising_counter_visibilidad_hipoglos.src = '' ;
				exit_merchandising_counter_visibilidad_hipoglos() ;
			}) ;
			...
			***********************************************/
			...
			auLocucion.src = 'audio/FundamentalesVenta/au_fundamentales_hipoglos_visibilidad_counter_bra.mp3' ;
