<!--Menu Metamucil-->
function anaquel_resumen()
{
	CleanScreen() ;
	
	gotoSlide = 'anaquel_resumen' ;
	...
	*****************************/
	...
	//Elements
	//Selecciona País
	"<div class='txt_Title_bullets' id='txt_Title_bullets'>Resumen <b>anaquel</b></div>"+

	//img 03 Graphic
	"<div class='img03_sld_03_inf_Mrc_C' id='img03_sld_03_inf_Mrc_C'>"+
		"<img src='img/Fundamentales/anaquel/anaquel_resumen.png' width='500'>"+
	"</div>"+

	//texto 2
	"<div style='color:#333; margin-top:-50px;' class='txt02_sld_03_inf_Mrc_C' id='txt02_sld_03_inf_Mrc_C'>"+
		"• En resumen, el anaquel es el área donde se exiben los productos, en el caso de medicamentos, los productos pueden estar en un anaquel, sobre el mostrador de ventas, detrás de el o en vitrinas. El porcentaje de espacio ocupado por las marcas de P&G en un anaquel es determinado por su participación de ventas.</br></br>"+
		"• Tu función en este fundamental es verificar que en todas las categorías estemos posicionados con visibilidad al consumidor, dentro de los objetivos de participación y en los mayores puntos posibles dentro y fuera del anaquel"+
	"</div>"+
	...
	//Elements
	//Selecciona País
	"<div class='txt_Title_bullets' id='txt_Title_bullets'>Resumo <b>shelf</b></div>"+
	...
	//texto 2
	"<div style='color:#333; margin-top:-50px;' class='txt02_sld_03_inf_Mrc_C' id='txt02_sld_03_inf_Mrc_C'>"+
		"• Em resumo, a prateleira é a zona onde os produtos são exiben, no caso dos medicamentos, os produtos podem ser sobre uma prateleira, sobre o balcão de venda, ou por trás dos armários. A percentagem de espaço ocupado por marcas P & G na prateleira é determinado pela sua quota de vendas.</br></br>"+
		"• O seu papel neste processo é fundamental para garantir que em todas as categorias que estão posicionados para informar o consumidor, dentro dos objetivos de participação e os pontos mais altos possíveis, dentro e fora da plataforma."+
	"</div>"+
	...
	switch( languageCountry )
	{
		...
		case 1:
			...
			***********************************************/
			...
			auLocucion.src = 'audio/FundamentalesVenta/au_Fundamentales_anaquelResumen_mx.mp3' ;
