<!--Video Intro-->
function tiposTiendas_autoservicios()
{
	CleanScreen() ;
	gotoSlide = 'tiposTiendas_autoservicios' ;
	...
	*****************************/
	var menuContent = 
		...
		//Farmacia Directa
		"<div class='shortCuts' id='ico_06'><img src='img/icons/ico_farmacia_autoservicios.png' onmouseover='rollOver_ico_06()' /></div>"+
	...
	*****************************/
	/////////////////////////////////México
	var tiposTiendas_autoservicios_mexico =	
		//Video
			//Container
		"<div class='videoContainer' id='videoContainer'>"+
		
			//Video Screen
			"<div class='videoScreen' id='videoScreen'><video controls='controls' autoplay='autoplay' id='vid_tiposTiendas_autoservicios' width='1090' height='614'></video></div>"+
	...
	/////////////////////////////////Brasil
	var tiposTiendas_autoservicios_brasil =	
		//Container
	...
	***********************************************/
	...
	switch( languageCountry )
	{
		//México
		case 1:
			document.getElementById("Container").innerHTML = generalElements + tiposTiendas_autoservicios_mexico ;
			...
			***********************************************/
			/////////////////////////////////Main Animation
			var vid_tiposTiendas_autoservicios = document.getElementById("vid_tiposTiendas_autoservicios") ;
			...
			{
				vid_tiposTiendas_autoservicios.src = 'video/Induccion/vid_tipoTienda_autoservicios_mex.mp4' ;
				vid_tiposTiendas_autoservicios.pause() ;
				
				if(vid_tiposTiendas_autoservicios.paused)
				{
					vid_tiposTiendas_autoservicios.play() ;
				}
			}
			
			/////////////////////////////////Exit Animation
			function exit_tiposTiendas_autoservicios_mex()
			{
				var vid_tiposTiendas_autoservicios = document.getElementById("vid_tiposTiendas_autoservicios") ;
				vid_tiposTiendas_autoservicios.src = '' ;
			...
			***********************************************/
			...
			$('#ico_01').click(function() {
				pagChange = -2 ;
				exit_tiposTiendas_autoservicios_mex() ;
			});
		...
		//Brasil
		case 5:
			document.getElementById("Container").innerHTML = generalElements + tiposTiendas_autoservicios_brasil ;
			...
			***********************************************/
			...
			/////////////////////////////////Exit Animation
			function exit_tiposTiendas_autoservicios()
			{
				var noDisponible = document.getElementById("noDisponible") ;
			...
			***********************************************/
			...
			$('#ico_01').click(function() {
				pagChange = -2 ;
				exit_tiposTiendas_autoservicios() ;
			});
