<!--Menu Tablet, celular y mochila-->
function menu_tabletCelularMochila()
{
	CleanScreen() ;
	
	gotoSlide = 'menu_tabletCelularMochila' ;
	...
	*****************************/
	/////////////////////////////////Mexico
	var menu_tabletCelularMochila_mexico =
		//Selecciona País
		...
		"<div class='menuElement' id='btn_02_02' onmouseover='rollOver_btn_02_02()'>"+
			//Image
			"<div class='me_Image'><img src='img/MenuElements/btn_entrenamientoSistema.png' /></div>"+
			//Shadow
			"<div class='me_Shadow'> <img src='img/MenuElements/img_buttonShadow.png' /></div>"+
		"</div>"+
		
		//Slide Number
		"<div class='slideNumber'>015</div>"+

	"" ;
	
	/////////////////////////////////Brasil
	var menu_tabletCelularMochila_brasil =
		//Selecciona País
		...
		"<div class='menuElement' id='btn_02_02' onmouseover='rollOver_btn_02_02()'>"+
			//Image
			"<div class='me_Image'><img src='img/MenuElements/btn_treinamentoSistema.png' /></div>"+
			//Shadow
			"<div class='me_Shadow'> <img src='img/MenuElements/img_buttonShadow.png' /></div>"+
		"</div>"+
	...
	***********************************************/
	...
	switch( languageCountry )
	{
		//México
		case 1:
			document.getElementById("Container").innerHTML = generalElements + menu_tabletCelularMochila_mexico ;
			...
			***********************************************/
			...
			/////////////////////////////////Exit animation
			function exit_menu_tabletCelularMochila_mex()
			{
				var txt_Title = document.getElementById("txt_Title") ;
			...
			***********************************************/
			...
			$('#ico_01').click(function() {
				pagChange = -2 ;
				exit_menu_tabletCelularMochila_mex() ;
			});
			...
			***********************************************/
			...
			auLocucion.src = 'audio/Induccion/au_menu_TabletCelularMochila_mex.mp3' ;
		...
		//Brasil
		case 5:
			document.getElementById("Container").innerHTML = generalElements + menu_tabletCelularMochila_brasil ;
			...
			***********************************************/
			...
			/////////////////////////////////Exit animation
			function exit_menu_tabletCelularMochila()
			{
				var txt_Title = document.getElementById("txt_Title") ;
			...
			***********************************************/
			...
			$('#ico_01').click(function() {
				pagChange = -2 ;
				exit_menu_tabletCelularMochila() ;
			});
			...
			***********************************************/
			...
			auLocucion.src = 'audio/Induccion/au_menu_TabletCelularMochila_bra.mp3' ;
